...
setvar_mappings = {
    ...
    ("userland_monitor_process_userland_monitor_thread", "Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_upper_desired_temp_1_Memory_Region"): "thermostat_rt_mri_mri_upper_desired_temp_queue_1",
    ("userland_monitor_process_userland_monitor_thread", "Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_lower_desired_temp_1_Memory_Region"): "thermostat_rt_mri_mri_lower_desired_temp_queue_1",
    ("userland_monitor_process_userland_monitor_thread", "Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_displayed_temp_1_Memory_Region"): "thermostat_rt_mri_mri_displayed_temp_queue_1",
    ("userland_monitor_process_userland_monitor_thread", "Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_regulator_status_1_Memory_Region"): "thermostat_rt_mri_mri_regulator_status_queue_1",
    ("userland_monitor_process_userland_monitor_thread", "Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_interface_failure_1_Memory_Region"): "thermostat_rt_mri_mri_interface_failure_queue_1",
    ("userland_monitor_process_userland_monitor_thread", "Isolette_Single_Sensor_Instance_thermostat_rt_mhs_mhs_heat_control_1_Memory_Region"): "thermostat_rt_mhs_mhs_heat_control_queue_1",
    ("userland_monitor_process_userland_monitor_thread", "Isolette_Single_Sensor_Instance_thermostat_rt_mrm_mrm_regulator_mode_1_Memory_Region"): "thermostat_rt_mrm_mrm_regulator_mode_queue_1",
    ("userland_monitor_process_userland_monitor_thread", "Isolette_Single_Sensor_Instance_thermostat_rt_drf_drf_internal_failure_1_Memory_Region"): "thermostat_rt_drf_drf_internal_failure_queue_1",
    ("userland_monitor_process_userland_monitor_thread", "Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_upper_alarm_temp_1_Memory_Region"): "thermostat_mt_mmi_mmi_upper_alarm_temp_queue_1",
    ("userland_monitor_process_userland_monitor_thread", "Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_lower_alarm_temp_1_Memory_Region"): "thermostat_mt_mmi_mmi_lower_alarm_temp_queue_1",
    ("userland_monitor_process_userland_monitor_thread", "Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_monitor_status_1_Memory_Region"): "thermostat_mt_mmi_mmi_monitor_status_queue_1",
    ("userland_monitor_process_userland_monitor_thread", "Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_interface_failure_1_Memory_Region"): "thermostat_mt_mmi_mmi_interface_failure_queue_1",
    ("userland_monitor_process_userland_monitor_thread", "Isolette_Single_Sensor_Instance_thermostat_mt_ma_ma_alarm_control_1_Memory_Region"): "thermostat_mt_ma_ma_alarm_control_queue_1",
    ("userland_monitor_process_userland_monitor_thread", "Isolette_Single_Sensor_Instance_thermostat_mt_mmm_mmm_monitor_mode_1_Memory_Region"): "thermostat_mt_mmm_mmm_monitor_mode_queue_1",
    ("userland_monitor_process_userland_monitor_thread", "Isolette_Single_Sensor_Instance_thermostat_mt_dmf_dmf_internal_failure_1_Memory_Region"): "thermostat_mt_dmf_dmf_internal_failure_queue_1",
    ("userland_monitor_process_userland_monitor_thread", "Isolette_Single_Sensor_Instance_operator_interface_oip_oit_lower_desired_tempWstatus_1_Memory_Region"): "operator_interface_oip_oit_lower_desired_tempWstatus_queue_1",
    ("userland_monitor_process_userland_monitor_thread", "Isolette_Single_Sensor_Instance_operator_interface_oip_oit_upper_desired_tempWstatus_1_Memory_Region"): "operator_interface_oip_oit_upper_desired_tempWstatus_queue_1",
    ("userland_monitor_process_userland_monitor_thread", "Isolette_Single_Sensor_Instance_operator_interface_oip_oit_lower_alarm_tempWstatus_1_Memory_Region"): "operator_interface_oip_oit_lower_alarm_tempWstatus_queue_1",
    ("userland_monitor_process_userland_monitor_thread", "Isolette_Single_Sensor_Instance_operator_interface_oip_oit_upper_alarm_tempWstatus_1_Memory_Region"): "operator_interface_oip_oit_upper_alarm_tempWstatus_queue_1",
    ("userland_monitor_process_userland_monitor_thread", "Isolette_Single_Sensor_Instance_temperature_sensor_cpi_thermostat_current_tempWstatus_1_Memory_Region"): "temperature_sensor_cpi_thermostat_current_tempWstatus_queue_1",
    ("userland_monitor_process_userland_monitor_thread", "Isolette_Single_Sensor_Instance_userland_monitor_process_userland_monitor_thread_sched_state_1_Memory_Region"): "sched_state_queue_1",
    ("userland_monitor_process_userland_monitor_thread", "Isolette_Single_Sensor_Instance_userland_monitor_process_userland_monitor_thread_sched_schedule_1_Memory_Region"): "sched_schedule_queue_1",
    ("gumbo_monitor_process_gumbo_monitor_thread", "Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_upper_desired_temp_1_Memory_Region"): "thermostat_rt_mri_mri_upper_desired_temp_queue_1",
    ("gumbo_monitor_process_gumbo_monitor_thread", "Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_lower_desired_temp_1_Memory_Region"): "thermostat_rt_mri_mri_lower_desired_temp_queue_1",
    ("gumbo_monitor_process_gumbo_monitor_thread", "Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_displayed_temp_1_Memory_Region"): "thermostat_rt_mri_mri_displayed_temp_queue_1",
    ("gumbo_monitor_process_gumbo_monitor_thread", "Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_regulator_status_1_Memory_Region"): "thermostat_rt_mri_mri_regulator_status_queue_1",
    ("gumbo_monitor_process_gumbo_monitor_thread", "Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_interface_failure_1_Memory_Region"): "thermostat_rt_mri_mri_interface_failure_queue_1",
    ("gumbo_monitor_process_gumbo_monitor_thread", "Isolette_Single_Sensor_Instance_thermostat_rt_mhs_mhs_heat_control_1_Memory_Region"): "thermostat_rt_mhs_mhs_heat_control_queue_1",
    ("gumbo_monitor_process_gumbo_monitor_thread", "Isolette_Single_Sensor_Instance_thermostat_rt_mrm_mrm_regulator_mode_1_Memory_Region"): "thermostat_rt_mrm_mrm_regulator_mode_queue_1",
    ("gumbo_monitor_process_gumbo_monitor_thread", "Isolette_Single_Sensor_Instance_thermostat_rt_drf_drf_internal_failure_1_Memory_Region"): "thermostat_rt_drf_drf_internal_failure_queue_1",
    ("gumbo_monitor_process_gumbo_monitor_thread", "Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_upper_alarm_temp_1_Memory_Region"): "thermostat_mt_mmi_mmi_upper_alarm_temp_queue_1",
    ("gumbo_monitor_process_gumbo_monitor_thread", "Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_lower_alarm_temp_1_Memory_Region"): "thermostat_mt_mmi_mmi_lower_alarm_temp_queue_1",
    ("gumbo_monitor_process_gumbo_monitor_thread", "Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_monitor_status_1_Memory_Region"): "thermostat_mt_mmi_mmi_monitor_status_queue_1",
    ("gumbo_monitor_process_gumbo_monitor_thread", "Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_interface_failure_1_Memory_Region"): "thermostat_mt_mmi_mmi_interface_failure_queue_1",
    ("gumbo_monitor_process_gumbo_monitor_thread", "Isolette_Single_Sensor_Instance_thermostat_mt_ma_ma_alarm_control_1_Memory_Region"): "thermostat_mt_ma_ma_alarm_control_queue_1",
    ("gumbo_monitor_process_gumbo_monitor_thread", "Isolette_Single_Sensor_Instance_thermostat_mt_mmm_mmm_monitor_mode_1_Memory_Region"): "thermostat_mt_mmm_mmm_monitor_mode_queue_1",
    ("gumbo_monitor_process_gumbo_monitor_thread", "Isolette_Single_Sensor_Instance_thermostat_mt_dmf_dmf_internal_failure_1_Memory_Region"): "thermostat_mt_dmf_dmf_internal_failure_queue_1",
    ("gumbo_monitor_process_gumbo_monitor_thread", "Isolette_Single_Sensor_Instance_operator_interface_oip_oit_lower_desired_tempWstatus_1_Memory_Region"): "operator_interface_oip_oit_lower_desired_tempWstatus_queue_1",
    ("gumbo_monitor_process_gumbo_monitor_thread", "Isolette_Single_Sensor_Instance_operator_interface_oip_oit_upper_desired_tempWstatus_1_Memory_Region"): "operator_interface_oip_oit_upper_desired_tempWstatus_queue_1",
    ("gumbo_monitor_process_gumbo_monitor_thread", "Isolette_Single_Sensor_Instance_operator_interface_oip_oit_lower_alarm_tempWstatus_1_Memory_Region"): "operator_interface_oip_oit_lower_alarm_tempWstatus_queue_1",
    ("gumbo_monitor_process_gumbo_monitor_thread", "Isolette_Single_Sensor_Instance_operator_interface_oip_oit_upper_alarm_tempWstatus_1_Memory_Region"): "operator_interface_oip_oit_upper_alarm_tempWstatus_queue_1",
    ("gumbo_monitor_process_gumbo_monitor_thread", "Isolette_Single_Sensor_Instance_temperature_sensor_cpi_thermostat_current_tempWstatus_1_Memory_Region"): "temperature_sensor_cpi_thermostat_current_tempWstatus_queue_1",
    ("gumbo_monitor_process_gumbo_monitor_thread", "Isolette_Single_Sensor_Instance_gumbo_monitor_process_gumbo_monitor_thread_sched_state_1_Memory_Region"): "sched_state_queue_1",
    ("gumbo_monitor_process_gumbo_monitor_thread", "Isolette_Single_Sensor_Instance_gumbo_monitor_process_gumbo_monitor_thread_sched_schedule_1_Memory_Region"): "sched_schedule_queue_1"
}
...
def generate(sdf_path: str, output_dir: str, dtb: DeviceTree):
    ...
    userland_monitor_process_userland_monitor_thread_MON = ProtectionDomain("userland_monitor_process_userland_monitor_thread_MON", "userland_monitor_process_userland_monitor_thread_MON.elf", priority=150, passive=True)
    scheduler.add_child_pd(userland_monitor_process_userland_monitor_thread_MON)
    gumbo_monitor_process_gumbo_monitor_thread_MON = ProtectionDomain("gumbo_monitor_process_gumbo_monitor_thread_MON", "gumbo_monitor_process_gumbo_monitor_thread_MON.elf", priority=150, passive=True)
    scheduler.add_child_pd(gumbo_monitor_process_gumbo_monitor_thread_MON)
    sys_assert_monitor_process_sys_assert_monitor_thread_MON = ProtectionDomain("sys_assert_monitor_process_sys_assert_monitor_thread_MON", "sys_assert_monitor_process_sys_assert_monitor_thread_MON.elf", priority=150, passive=True)
    scheduler.add_child_pd(sys_assert_monitor_process_sys_assert_monitor_thread_MON)
    ...
    userland_monitor_process_userland_monitor_thread = ProtectionDomain("userland_monitor_process_userland_monitor_thread", "userland_monitor_process_userland_monitor_thread.elf", priority=140, passive=True)
    scheduler.add_child_pd(userland_monitor_process_userland_monitor_thread)
    gumbo_monitor_process_gumbo_monitor_thread = ProtectionDomain("gumbo_monitor_process_gumbo_monitor_thread", "gumbo_monitor_process_gumbo_monitor_thread.elf", priority=140, passive=True)
    scheduler.add_child_pd(gumbo_monitor_process_gumbo_monitor_thread)
    sys_assert_monitor_process_sys_assert_monitor_thread = ProtectionDomain("sys_assert_monitor_process_sys_assert_monitor_thread", "sys_assert_monitor_process_sys_assert_monitor_thread.elf", priority=140, passive=True)
    scheduler.add_child_pd(sys_assert_monitor_process_sys_assert_monitor_thread)
    ...
    userland_monitor_process_userland_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_upper_desired_temp_1_Memory_Region, 0x10_000_000, perms="r"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_upper_desired_temp_1_Memory_Region, 0x10_000_000, perms="r"))
    sys_assert_monitor_process_sys_assert_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_upper_desired_temp_1_Memory_Region, 0x10_000_000, perms="r"))
    ...
    userland_monitor_process_userland_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_lower_desired_temp_1_Memory_Region, 0x10_001_000, perms="r"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_lower_desired_temp_1_Memory_Region, 0x10_001_000, perms="r"))
    sys_assert_monitor_process_sys_assert_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_lower_desired_temp_1_Memory_Region, 0x10_001_000, perms="r"))
    ...
    userland_monitor_process_userland_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_displayed_temp_1_Memory_Region, 0x10_002_000, perms="r"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_displayed_temp_1_Memory_Region, 0x10_002_000, perms="r"))
    sys_assert_monitor_process_sys_assert_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_displayed_temp_1_Memory_Region, 0x10_002_000, perms="r"))
    ...
    userland_monitor_process_userland_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_regulator_status_1_Memory_Region, 0x10_003_000, perms="r"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_regulator_status_1_Memory_Region, 0x10_003_000, perms="r"))
    sys_assert_monitor_process_sys_assert_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_regulator_status_1_Memory_Region, 0x10_003_000, perms="r"))
    ...
    userland_monitor_process_userland_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_interface_failure_1_Memory_Region, 0x10_004_000, perms="r"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_interface_failure_1_Memory_Region, 0x10_004_000, perms="r"))
    sys_assert_monitor_process_sys_assert_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_interface_failure_1_Memory_Region, 0x10_004_000, perms="r"))
    ...
    userland_monitor_process_userland_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mhs_mhs_heat_control_1_Memory_Region, 0x10_005_000, perms="r"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mhs_mhs_heat_control_1_Memory_Region, 0x10_005_000, perms="r"))
    sys_assert_monitor_process_sys_assert_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mhs_mhs_heat_control_1_Memory_Region, 0x10_005_000, perms="r"))
    thermostat_rt_mhs_mhs.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mhs_mhs_sv_lastCmd_1_Memory_Region, 0x10_003_000, perms="rw"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mhs_mhs_sv_lastCmd_1_Memory_Region, 0x10_006_000, perms="r"))
    sys_assert_monitor_process_sys_assert_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mhs_mhs_sv_lastCmd_1_Memory_Region, 0x10_006_000, perms="r"))
    ...
    thermostat_rt_mhs_mhs.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mrm_mrm_regulator_mode_1_Memory_Region, 0x10_004_000, perms="r"))
    ...
    userland_monitor_process_userland_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mrm_mrm_regulator_mode_1_Memory_Region, 0x10_006_000, perms="r"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mrm_mrm_regulator_mode_1_Memory_Region, 0x10_007_000, perms="r"))
    sys_assert_monitor_process_sys_assert_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mrm_mrm_regulator_mode_1_Memory_Region, 0x10_007_000, perms="r"))
    thermostat_rt_mrm_mrm.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mrm_mrm_sv_lastRegulatorMode_1_Memory_Region, 0x10_002_000, perms="rw"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mrm_mrm_sv_lastRegulatorMode_1_Memory_Region, 0x10_008_000, perms="r"))
    sys_assert_monitor_process_sys_assert_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mrm_mrm_sv_lastRegulatorMode_1_Memory_Region, 0x10_008_000, perms="r"))
    thermostat_rt_mrm_mrm.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_drf_drf_internal_failure_1_Memory_Region, 0x10_003_000, perms="r"))
    ...
    userland_monitor_process_userland_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_drf_drf_internal_failure_1_Memory_Region, 0x10_007_000, perms="r"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_drf_drf_internal_failure_1_Memory_Region, 0x10_009_000, perms="r"))
    sys_assert_monitor_process_sys_assert_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_drf_drf_internal_failure_1_Memory_Region, 0x10_009_000, perms="r"))
    ...
    userland_monitor_process_userland_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_upper_alarm_temp_1_Memory_Region, 0x10_008_000, perms="r"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_upper_alarm_temp_1_Memory_Region, 0x10_00A_000, perms="r"))
    sys_assert_monitor_process_sys_assert_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_upper_alarm_temp_1_Memory_Region, 0x10_00A_000, perms="r"))
    ...
    userland_monitor_process_userland_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_lower_alarm_temp_1_Memory_Region, 0x10_009_000, perms="r"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_lower_alarm_temp_1_Memory_Region, 0x10_00B_000, perms="r"))
    sys_assert_monitor_process_sys_assert_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_lower_alarm_temp_1_Memory_Region, 0x10_00B_000, perms="r"))
    ...
    userland_monitor_process_userland_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_monitor_status_1_Memory_Region, 0x10_00A_000, perms="r"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_monitor_status_1_Memory_Region, 0x10_00C_000, perms="r"))
    sys_assert_monitor_process_sys_assert_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_monitor_status_1_Memory_Region, 0x10_00C_000, perms="r"))
    ...
    userland_monitor_process_userland_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_interface_failure_1_Memory_Region, 0x10_00B_000, perms="r"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_interface_failure_1_Memory_Region, 0x10_00D_000, perms="r"))
    sys_assert_monitor_process_sys_assert_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_interface_failure_1_Memory_Region, 0x10_00D_000, perms="r"))
    thermostat_mt_mmi_mmi.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_sv_lastCmd_1_Memory_Region, 0x10_004_000, perms="rw"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_sv_lastCmd_1_Memory_Region, 0x10_00E_000, perms="r"))
    sys_assert_monitor_process_sys_assert_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_sv_lastCmd_1_Memory_Region, 0x10_00E_000, perms="r"))
    ...
    userland_monitor_process_userland_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_ma_ma_alarm_control_1_Memory_Region, 0x10_00C_000, perms="r"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_ma_ma_alarm_control_1_Memory_Region, 0x10_00F_000, perms="r"))
    sys_assert_monitor_process_sys_assert_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_ma_ma_alarm_control_1_Memory_Region, 0x10_00F_000, perms="r"))
    thermostat_mt_ma_ma.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_ma_ma_sv_lastCmd_1_Memory_Region, 0x10_003_000, perms="rw"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_ma_ma_sv_lastCmd_1_Memory_Region, 0x10_010_000, perms="r"))
    sys_assert_monitor_process_sys_assert_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_ma_ma_sv_lastCmd_1_Memory_Region, 0x10_010_000, perms="r"))
    thermostat_mt_mmi_mmi.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmm_mmm_monitor_mode_1_Memory_Region, 0x10_005_000, perms="r"))
    thermostat_mt_ma_ma.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmm_mmm_monitor_mode_1_Memory_Region, 0x10_004_000, perms="r"))
    ...
    userland_monitor_process_userland_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmm_mmm_monitor_mode_1_Memory_Region, 0x10_00D_000, perms="r"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmm_mmm_monitor_mode_1_Memory_Region, 0x10_011_000, perms="r"))
    sys_assert_monitor_process_sys_assert_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmm_mmm_monitor_mode_1_Memory_Region, 0x10_011_000, perms="r"))
    thermostat_mt_mmm_mmm.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmm_mmm_sv_lastMonitorMode_1_Memory_Region, 0x10_002_000, perms="rw"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmm_mmm_sv_lastMonitorMode_1_Memory_Region, 0x10_012_000, perms="r"))
    sys_assert_monitor_process_sys_assert_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmm_mmm_sv_lastMonitorMode_1_Memory_Region, 0x10_012_000, perms="r"))
    thermostat_mt_mmm_mmm.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_dmf_dmf_internal_failure_1_Memory_Region, 0x10_003_000, perms="r"))
    ...
    userland_monitor_process_userland_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_dmf_dmf_internal_failure_1_Memory_Region, 0x10_00E_000, perms="r"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_dmf_dmf_internal_failure_1_Memory_Region, 0x10_013_000, perms="r"))
    sys_assert_monitor_process_sys_assert_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_dmf_dmf_internal_failure_1_Memory_Region, 0x10_013_000, perms="r"))
    ...
    userland_monitor_process_userland_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_operator_interface_oip_oit_lower_desired_tempWstatus_1_Memory_Region, 0x10_00F_000, perms="r"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_operator_interface_oip_oit_lower_desired_tempWstatus_1_Memory_Region, 0x10_014_000, perms="r"))
    sys_assert_monitor_process_sys_assert_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_operator_interface_oip_oit_lower_desired_tempWstatus_1_Memory_Region, 0x10_014_000, perms="r"))
    ...
    userland_monitor_process_userland_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_operator_interface_oip_oit_upper_desired_tempWstatus_1_Memory_Region, 0x10_010_000, perms="r"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_operator_interface_oip_oit_upper_desired_tempWstatus_1_Memory_Region, 0x10_015_000, perms="r"))
    sys_assert_monitor_process_sys_assert_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_operator_interface_oip_oit_upper_desired_tempWstatus_1_Memory_Region, 0x10_015_000, perms="r"))
    thermostat_mt_mmi_mmi.add_map(Map(Isolette_Single_Sensor_Instance_operator_interface_oip_oit_lower_alarm_tempWstatus_1_Memory_Region, 0x10_006_000, perms="r"))
    ...
    userland_monitor_process_userland_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_operator_interface_oip_oit_lower_alarm_tempWstatus_1_Memory_Region, 0x10_011_000, perms="r"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_operator_interface_oip_oit_lower_alarm_tempWstatus_1_Memory_Region, 0x10_016_000, perms="r"))
    sys_assert_monitor_process_sys_assert_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_operator_interface_oip_oit_lower_alarm_tempWstatus_1_Memory_Region, 0x10_016_000, perms="r"))
    thermostat_mt_mmi_mmi.add_map(Map(Isolette_Single_Sensor_Instance_operator_interface_oip_oit_upper_alarm_tempWstatus_1_Memory_Region, 0x10_007_000, perms="r"))
    ...
    userland_monitor_process_userland_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_operator_interface_oip_oit_upper_alarm_tempWstatus_1_Memory_Region, 0x10_012_000, perms="r"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_operator_interface_oip_oit_upper_alarm_tempWstatus_1_Memory_Region, 0x10_017_000, perms="r"))
    sys_assert_monitor_process_sys_assert_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_operator_interface_oip_oit_upper_alarm_tempWstatus_1_Memory_Region, 0x10_017_000, perms="r"))
    ...
    thermostat_rt_mhs_mhs.add_map(Map(Isolette_Single_Sensor_Instance_temperature_sensor_cpi_thermostat_current_tempWstatus_1_Memory_Region, 0x10_005_000, perms="r"))
    thermostat_rt_mrm_mrm.add_map(Map(Isolette_Single_Sensor_Instance_temperature_sensor_cpi_thermostat_current_tempWstatus_1_Memory_Region, 0x10_004_000, perms="r"))
    thermostat_mt_mmi_mmi.add_map(Map(Isolette_Single_Sensor_Instance_temperature_sensor_cpi_thermostat_current_tempWstatus_1_Memory_Region, 0x10_008_000, perms="r"))
    thermostat_mt_ma_ma.add_map(Map(Isolette_Single_Sensor_Instance_temperature_sensor_cpi_thermostat_current_tempWstatus_1_Memory_Region, 0x10_005_000, perms="r"))
    thermostat_mt_mmm_mmm.add_map(Map(Isolette_Single_Sensor_Instance_temperature_sensor_cpi_thermostat_current_tempWstatus_1_Memory_Region, 0x10_004_000, perms="r"))
    ...
    userland_monitor_process_userland_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_temperature_sensor_cpi_thermostat_current_tempWstatus_1_Memory_Region, 0x10_013_000, perms="r"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_temperature_sensor_cpi_thermostat_current_tempWstatus_1_Memory_Region, 0x10_018_000, perms="r"))
    sys_assert_monitor_process_sys_assert_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_temperature_sensor_cpi_thermostat_current_tempWstatus_1_Memory_Region, 0x10_018_000, perms="r"))
    ...
    channel_sys_assert_monitor_process_sys_assert_monitor_thread_MON = 15
    ...
    sdf.add_channel(Channel(scheduler, userland_monitor_process_userland_monitor_thread_MON, a_id=channel_userland_monitor_process_userland_monitor_thread_MON, b_id=0))
    sdf.add_channel(Channel(userland_monitor_process_userland_monitor_thread_MON, userland_monitor_process_userland_monitor_thread, a_id=1, b_id=0))
    sdf.add_channel(Channel(scheduler, gumbo_monitor_process_gumbo_monitor_thread_MON, a_id=channel_gumbo_monitor_process_gumbo_monitor_thread_MON, b_id=0))
    sdf.add_channel(Channel(gumbo_monitor_process_gumbo_monitor_thread_MON, gumbo_monitor_process_gumbo_monitor_thread, a_id=1, b_id=0))
    sdf.add_channel(Channel(scheduler, sys_assert_monitor_process_sys_assert_monitor_thread_MON, a_id=channel_sys_assert_monitor_process_sys_assert_monitor_thread_MON, b_id=0))
    sdf.add_channel(Channel(sys_assert_monitor_process_sys_assert_monitor_thread_MON, sys_assert_monitor_process_sys_assert_monitor_thread, a_id=1, b_id=0))
    ...
    ts_sys_assert_monitor_process_sys_assert_monitor_thread_MON = (channel_sys_assert_monitor_process_sys_assert_monitor_thread_MON, 50000000, False)
    ts_pad = (0, 190000000, False)
    ...
    user_schedule = schedule(
      ...
      ts_sys_assert_monitor_process_sys_assert_monitor_thread_MON,
      ts_pad
    )
