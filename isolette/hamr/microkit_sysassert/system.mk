...
CFLAGS += \
	...
	-I$(TOP_DIR)/components/sys_assert_monitor_process_sys_assert_monitor_thread/include
...
vpath %.c $(SDDF) \
	...
	$(TOP_DIR)/components/sys_assert_monitor_process_sys_assert_monitor_thread/src
...
IMAGES := timer_driver.elf scheduler.elf \
	...
	sys_assert_monitor_process_sys_assert_monitor_thread.elf \
	sys_assert_monitor_process_sys_assert_monitor_thread_MON.elf
...
# user code
sys_assert_monitor_process_sys_assert_monitor_thread_rust:
	make -C ${CRATES_DIR}/sys_assert_monitor_process_sys_assert_monitor_thread $(RUST_MAKE_TARGET)
...
sys_assert_monitor_process_sys_assert_monitor_thread_MON.elf: sys_assert_monitor_process_sys_assert_monitor_thread_MON_user.o sys_assert_monitor_process_sys_assert_monitor_thread_MON.o
	$(LD) $(LDFLAGS) $^ $(LIBS) -o $@

sys_assert_monitor_process_sys_assert_monitor_thread.elf: $(UTIL_OBJS) $(TYPE_OBJS) sys_assert_monitor_process_sys_assert_monitor_thread_rust sys_assert_monitor_process_sys_assert_monitor_thread.o
	$(LD) $(LDFLAGS) -L ${CRATES_DIR}/sys_assert_monitor_process_sys_assert_monitor_thread/target/aarch64-unknown-none/release $(filter %.o, $^) $(LIBS) -lsys_assert_monitor_process_sys_assert_monitor_thread -o $@
...
test:: 
	...
	make -C ${CRATES_DIR}/sys_assert_monitor_process_sys_assert_monitor_thread test
...
clean:: 
	...
	make -C ${CRATES_DIR}/sys_assert_monitor_process_sys_assert_monitor_thread clean
...
verus: 
	...
	make -C ${CRATES_DIR}/sys_assert_monitor_process_sys_assert_monitor_thread verus
