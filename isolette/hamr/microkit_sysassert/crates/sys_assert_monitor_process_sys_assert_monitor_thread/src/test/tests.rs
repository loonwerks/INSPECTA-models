...
mod tests {
  ...
  fn test_initialization() {
    crate::sys_assert_monitor_process_sys_assert_monitor_thread_initialize();
}
  ...
  fn test_compute() {
    ...
    test_apis::put_thermostat_rt_mhs_mhs_sv_lastCmd(Isolette_Data_Model::On_Off::default());
    test_apis::put_thermostat_rt_mrm_mrm_sv_lastRegulatorMode(Isolette_Data_Model::Regulator_Mode::default());
    test_apis::put_thermostat_mt_mmi_mmi_sv_lastCmd(Isolette_Data_Model::On_Off::default());
    test_apis::put_thermostat_mt_ma_ma_sv_lastCmd(Isolette_Data_Model::On_Off::default());
    test_apis::put_thermostat_mt_mmm_mmm_sv_lastMonitorMode(Isolette_Data_Model::Monitor_Mode::default());
    test_apis::put_sched_state(hamr::SchedState::default());
    test_apis::put_sched_schedule(hamr::Schedule::default());

    crate::sys_assert_monitor_process_sys_assert_monitor_thread_timeTriggered();
  }
}
