...
setvar_mappings = {
    ...
    ("userland_monitor_process_userland_monitor_thread", "sched_state"): "sched_state_queue_1",
    ("userland_monitor_process_userland_monitor_thread", "sched_schedule"): "sched_schedule_queue_1"
}
...
def generate(sdf_path: str, output_dir: str, dtb: DeviceTree):
    ...
    userland_monitor_process_userland_monitor_thread.add_map(Map(sched_state, 0x10_014_000, perms="r"))
    userland_monitor_process_userland_monitor_thread.add_map(Map(sched_schedule, 0x10_015_000, perms="r"))
