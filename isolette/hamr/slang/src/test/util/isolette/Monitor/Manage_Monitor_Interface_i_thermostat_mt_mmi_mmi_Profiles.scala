...
@msig trait Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi_Profile_Trait extends Profile

@record class Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi_Profile (
  val name: String,
) extends Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi_Profile_Trait {
...
@msig trait Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi_Profile_P_Trait extends Profile {
...
@record class Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi_Profile_P(
  ...
  var api_lower_alarm_tempWstatus: RandomLib, // random lib for generating Isolette_Data_Model.TempWstatus_i
  var api_monitor_mode: RandomLib, // random lib for generating Isolette_Data_Model.Monitor_Mode
  var api_upper_alarm_tempWstatus: RandomLib // random lib for generating Isolette_Data_Model.TempWstatus_i
  ) extends Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi_Profile_P_Trait {

  override def next: Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi_PreState_Container_P = {
    return (Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi_PreState_Container_P (
...
@msig trait Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi_Profile_PS_Trait extends Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi_Profile_P_Trait {
...
@record class Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi_Profile_PS(
  ...
  var api_monitor_mode: RandomLib, // random lib for generating Isolette_Data_Model.Monitor_Mode
  var api_upper_alarm_tempWstatus: RandomLib // random lib for generating Isolette_Data_Model.TempWstatus_i
  ) extends Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi_Profile_PS_Trait {

  override def next: Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi_PreState_Container_PS = {
    return (Manage_Monitor_Interface_i_thermostat_mt_mmi_mmi_PreState_Container_PS (
