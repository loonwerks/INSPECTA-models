...
object Manage_Alarm_i_thermostat_mt_ma_ma_GumboX {
  /** I-Assm: Integration constraint on ma's incoming data port lower_alarm_temp
    *
    * assume Table_A_12_LowerAlarmTemp
    *   Range [96..101]
    *   http://pub.santoslab.org/high-assurance/module-requirements/reading/FAA-DoT-Requirements-AR-08-32.pdf#page=112 
    */
  @strictpure def I_Assm_lower_alarm_temp(lower_alarm_temp: Isolette_Data_Model.Temp_i): B =
    96.0f <= lower_alarm_temp.value &&
      lower_alarm_temp.value <= 101.0f

  // I-Assm-Guard: Integration constraint on ma's incoming data port lower_alarm_temp
  @strictpure def I_Assm_Guard_lower_alarm_temp(lower_alarm_temp: Isolette_Data_Model.Temp_i): B =
    I_Assm_lower_alarm_temp(lower_alarm_temp)

  /** I-Assm: Integration constraint on ma's incoming data port upper_alarm_temp
    *
    * assume Table_A_12_UpperAlarmTemp
    *   Range [97..102]
    *   http://pub.santoslab.org/high-assurance/module-requirements/reading/FAA-DoT-Requirements-AR-08-32.pdf#page=112 
    */
  @strictpure def I_Assm_upper_alarm_temp(upper_alarm_temp: Isolette_Data_Model.Temp_i): B =
    97.0f <= upper_alarm_temp.value &&
      upper_alarm_temp.value <= 102.0f

  // I-Assm-Guard: Integration constraint on ma's incoming data port upper_alarm_temp
  @strictpure def I_Assm_Guard_upper_alarm_temp(upper_alarm_temp: Isolette_Data_Model.Temp_i): B =
    I_Assm_upper_alarm_temp(upper_alarm_temp)
  ...
  @strictpure def compute_CEP_Pre (
      ...
      api_upper_alarm_temp: Isolette_Data_Model.Temp_i): B =
    (// I-Assm-Guard: Integration constraints for ma's incoming ports
     I_Assm_Guard_lower_alarm_temp(api_lower_alarm_temp) & 
     I_Assm_Guard_upper_alarm_temp(api_upper_alarm_temp) & 
