...
// SB_QUEUE_ISOLETTE_ISOLETTE_DATA_MODEL_TEMPWSTATUS_I_1_SIZE-1 elements.
#define SB_QUEUE_ISOLETTE_ISOLETTE_DATA_MODEL_TEMPWSTATUS_I_1_SIZE 2
...
typedef struct sb_queue_isolette_Isolette_Data_Model_TempWstatus_i_1 {
  ...
  // Queue of elements of type isolette_Isolette_Data_Model_TempWstatus_i
  // (see sb_types.h) implemented as a ring buffer.
  // No initialization necessary.
  isolette_Isolette_Data_Model_TempWstatus_i elt[SB_QUEUE_ISOLETTE_ISOLETTE_DATA_MODEL_TEMPWSTATUS_I_1_SIZE];

} sb_queue_isolette_Isolette_Data_Model_TempWstatus_i_1_t;
...
void sb_queue_isolette_Isolette_Data_Model_TempWstatus_i_1_init(sb_queue_isolette_Isolette_Data_Model_TempWstatus_i_1_t *queue);

// Enqueue data. This always succeeds and never blocks. Data is copied.
void sb_queue_isolette_Isolette_Data_Model_TempWstatus_i_1_enqueue(
  sb_queue_isolette_Isolette_Data_Model_TempWstatus_i_1_t *queue,
  isolette_Isolette_Data_Model_TempWstatus_i *data);
...
typedef struct sb_queue_isolette_Isolette_Data_Model_TempWstatus_i_1_Recv {
...
} sb_queue_isolette_Isolette_Data_Model_TempWstatus_i_1_Recv_t;

// Each receiver must call this exactly once before any calls to other queue
// API functions.
void sb_queue_isolette_Isolette_Data_Model_TempWstatus_i_1_Recv_init(
  sb_queue_isolette_Isolette_Data_Model_TempWstatus_i_1_Recv_t *recvQueue,
  sb_queue_isolette_Isolette_Data_Model_TempWstatus_i_1_t *queue);
...
// dropped since the last call to sb_queue_isolette_Isolette_Data_Model_TempWstatus_i_1_dequeue(). *data is left in
// unspecified state.
//
// If the sender ever gets ahead of a receiver by more than COUNTER_MAX,
// sb_queue_isolette_Isolette_Data_Model_TempWstatus_i_1_dequeue will fail to count a multiple of COUNTER_MAX in
...
bool sb_queue_isolette_Isolette_Data_Model_TempWstatus_i_1_dequeue(
  sb_queue_isolette_Isolette_Data_Model_TempWstatus_i_1_Recv_t *recvQueue,
...
bool sb_queue_isolette_Isolette_Data_Model_TempWstatus_i_1_is_empty(sb_queue_isolette_Isolette_Data_Model_TempWstatus_i_1_Recv_t *recvQueue);
