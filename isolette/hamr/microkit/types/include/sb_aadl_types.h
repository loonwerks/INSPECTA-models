...
typedef struct isolette_Isolette_Data_Model_PhysicalTemp_i isolette_Isolette_Data_Model_PhysicalTemp_i;

typedef struct isolette_Isolette_Data_Model_TempWstatus_i isolette_Isolette_Data_Model_TempWstatus_i;

typedef struct isolette_Isolette_Data_Model_Temp_i isolette_Isolette_Data_Model_Temp_i;
