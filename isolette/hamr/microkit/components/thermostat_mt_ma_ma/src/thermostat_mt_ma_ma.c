...
uintmax_t get_upper_alarm_temp_num_invalid(void) {
  return sb_queue_Isolette_Data_Model_Temp_i_1_numInvalid((sb_queue_Isolette_Data_Model_Temp_i_1_Recv_t *) &upper_alarm_temp_recv_queue);
}
...
uintmax_t get_lower_alarm_temp_num_invalid(void) {
  return sb_queue_Isolette_Data_Model_Temp_i_1_numInvalid((sb_queue_Isolette_Data_Model_Temp_i_1_Recv_t *) &lower_alarm_temp_recv_queue);
}
