...
extern "C" {
  ...
  fn get_lower_alarm_temp_num_invalid() -> u64;
  fn get_upper_alarm_temp(value: *mut Isolette_Data_Model::Temp_i) -> bool;
  fn get_upper_alarm_temp_num_invalid() -> u64;
...
pub fn unsafe_get_lower_alarm_temp_num_invalid() -> u64
{
  unsafe {
    return get_lower_alarm_temp_num_invalid();
  }
}
...
pub fn unsafe_get_upper_alarm_temp_num_invalid() -> u64
{
  unsafe {
    return get_upper_alarm_temp_num_invalid();
  }
}
...
pub fn initialize_test_globals() {
  unsafe {
    ...
    *IN_lower_alarm_temp.lock().unwrap_or_else(|e| e.into_inner()) = None;
...
{
  unsafe {
    let guard = IN_lower_alarm_temp.lock().unwrap_or_else(|e| e.into_inner());
    *value = guard.expect("Not expecting None");
    true
  }
}
...
#[cfg(test)]
pub fn get_lower_alarm_temp_num_invalid() -> u64
{
  return 0;
}
...
{
  unsafe {
    let guard = IN_upper_alarm_temp.lock().unwrap_or_else(|e| e.into_inner());
    *value = guard.expect("Not expecting None");
    true
  }
}
...
#[cfg(test)]
pub fn get_upper_alarm_temp_num_invalid() -> u64
{
  return 0;
}
