  ...
  (
    ...
    proptest!{
      ...
      fn $test_name(
        ...
        match$crate::bridge::test_api::testComputeCB(api_current_tempWstatus, api_lower_alarm_temp, api_monitor_mode, api_upper_alarm_temp) {
          $crate::bridge::test_api::HarnessResult::RejectedPrecondition => {
...
{
  return testComputeCBwLV(container.In_lastCmd, container.api_current_tempWstatus, container.api_lower_alarm_temp, container.api_monitor_mode, container.api_upper_alarm_temp)
}
  ...
  (
    ...
    proptest!{
      ...
      fn $test_name(
        ...
        match $crate::bridge::test_api::testComputeCBwLV(In_lastCmd, api_current_tempWstatus, api_lower_alarm_temp, api_monitor_mode, api_upper_alarm_temp) {
          $crate::bridge::test_api::HarnessResult::RejectedPrecondition => {
            return Err(proptest::test_runner::TestCaseError::reject(
              "Precondition failed: invalid input combination",
            ))
