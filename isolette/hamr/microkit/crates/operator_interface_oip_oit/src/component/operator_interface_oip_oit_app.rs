  ...
  impl operator_interface_oip_oit {
    ...
    pub fn timeTriggered<API: operator_interface_oip_oit_Full_Api>(
      ...
      ensures
        ...
        GUMBO_Library::Allowed_AlarmTempWStatus_Ranges_spec(final(api).lower_alarm_tempWstatus, final(api).upper_alarm_tempWstatus),
        ...
        final(api).lower_desired_tempWstatus.degrees <= final(api).upper_desired_tempWstatus.degrees,
