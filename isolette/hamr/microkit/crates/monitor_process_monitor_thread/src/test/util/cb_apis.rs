...
pub fn testComputeCB(
  ...
  api_oip_oit_upper_desired_tempWstatus: Isolette_Data_Model::TempWstatus_i) -> HarnessResult
{
  // Initialize the app
  crate::monitor_process_monitor_thread_initialize();
    ...
    proptest!{
      ...
      fn $test_name(
        (
          ...
          (api_mrm_mrm_sv_lastRegulatorMode, api_oip_oit_lower_alarm_tempWstatus, api_oip_oit_lower_desired_tempWstatus, api_oip_oit_upper_alarm_tempWstatus, api_oip_oit_upper_desired_tempWstatus)
        ) in (
