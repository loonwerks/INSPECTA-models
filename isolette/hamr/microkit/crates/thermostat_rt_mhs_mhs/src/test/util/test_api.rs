...
/// pre-state container holding incoming port values and GUMBO state variables
...
/// pre-state container holding incoming port values
...
/// putter for GUMBO state variable
