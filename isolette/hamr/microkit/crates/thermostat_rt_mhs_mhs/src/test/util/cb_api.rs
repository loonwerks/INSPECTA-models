  ...
  (
    ...
    proptest!{
      ...
      fn $test_name(empty in ::proptest::strategy::Just(())) {
        match $crate::test::util::cb_api::testInitializeCB() {
          $crate::test::util::cb_api::HarnessResult::RejectedPrecondition => {
            unreachable!("This branch is infeasible")
          }
          $crate::test::util::cb_api::HarnessResult::FailedPostcondition(e) => {
            return Err(e)
          }
          $crate::test::util::cb_api::HarnessResult::Passed => { }
        }
      }
    }
  };
  ...
  (
    ...
    proptest!{
      ...
      fn $test_name(
        ...
        match$crate::test::util::cb_api::testComputeCB(api_current_tempWstatus, api_lower_desired_temp, api_regulator_mode, api_upper_desired_temp) {
          $crate::test::util::cb_api::HarnessResult::RejectedPrecondition => {
...
/** Contract-based test harness for the compute entry point
  */
pub fn testComputeCBwLV_container(container: PreStateContainer_wGSV) -> HarnessResult
{
  return testComputeCBwLV(container.In_lastCmd, container.api_current_tempWstatus, container.api_lower_desired_temp, container.api_regulator_mode, container.api_upper_desired_temp)
}
  ...
  (
    ...
    proptest!{
      ...
      fn $test_name(
        ...
        match $crate::test::util::cb_api::testComputeCBwLV(In_lastCmd, api_current_tempWstatus, api_lower_desired_temp, api_regulator_mode, api_upper_desired_temp) {
          $crate::test::util::cb_api::HarnessResult::RejectedPrecondition => {
            return Err(proptest::test_runner::TestCaseError::reject(
              "Precondition failed: invalid input combination",
            ))
