mod proptest_GUMBOX_unit_tests {
  ...
  testComputeCB_macro! {
    ...
    api_current_tempWstatus: proptest_generators::Isolette_Data_Model_TempWstatus_i_strategy_default(),
    api_lower_desired_temp: proptest_generators::Isolette_Data_Model_Temp_i_strategy_default(),
    api_regulator_mode: proptest_generators::Isolette_Data_Model_Regulator_Mode_strategy_default(),
    api_upper_desired_temp: proptest_generators::Isolette_Data_Model_Temp_i_strategy_default()
    /*
  ...
  testComputeCBwLV_macro! {
    ...
    */
    In_lastCmd: proptest_generators::Isolette_Data_Model_On_Off_strategy_default(),
    api_current_tempWstatus: proptest_generators::Isolette_Data_Model_TempWstatus_i_strategy_default(),
    api_lower_desired_temp: proptest_generators::Isolette_Data_Model_Temp_i_strategy_cust(94..=105),
    api_regulator_mode: proptest_generators::Isolette_Data_Model_Regulator_Mode_strategy_default(),
    api_upper_desired_temp: proptest_generators::Isolette_Data_Model_Temp_i_strategy_cust(94..=105)
  }
}
