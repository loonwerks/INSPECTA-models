...
TYPE_OBJS := $(TOP_DIR)/build/sb_queue_base_Isolette_Data_Model_Temp_i_1.o $(TOP_DIR)/build/sb_queue_base_Isolette_Data_Model_Temp_i_1.o $(TOP_DIR)/build/sb_queue_base_Isolette_Data_Model_Temp_i_1.o $(TOP_DIR)/build/sb_queue_base_Isolette_Data_Model_Status_Type_1.o $(TOP_DIR)/build/sb_queue_base_Isolette_Data_Model_Failure_Flag_i_1.o $(TOP_DIR)/build/sb_queue_base_Isolette_Data_Model_On_Off_Type_1.o $(TOP_DIR)/build/sb_queue_base_Isolette_Data_Model_Regulator_Mode_Type_1.o $(TOP_DIR)/build/sb_queue_base_Isolette_Data_Model_Failure_Flag_i_1.o $(TOP_DIR)/build/sb_queue_base_Isolette_Data_Model_Temp_i_1.o $(TOP_DIR)/build/sb_queue_base_Isolette_Data_Model_Temp_i_1.o $(TOP_DIR)/build/sb_queue_base_Isolette_Data_Model_Status_Type_1.o $(TOP_DIR)/build/sb_queue_base_Isolette_Data_Model_Failure_Flag_i_1.o $(TOP_DIR)/build/sb_queue_base_Isolette_Data_Model_On_Off_Type_1.o $(TOP_DIR)/build/sb_queue_base_Isolette_Data_Model_Monitor_Mode_Type_1.o $(TOP_DIR)/build/sb_queue_base_Isolette_Data_Model_Failure_Flag_i_1.o $(TOP_DIR)/build/sb_queue_base_Isolette_Data_Model_TempWstatus_i_1.o $(TOP_DIR)/build/sb_queue_base_Isolette_Data_Model_TempWstatus_i_1.o $(TOP_DIR)/build/sb_queue_base_Isolette_Data_Model_TempWstatus_i_1.o $(TOP_DIR)/build/sb_queue_base_Isolette_Data_Model_TempWstatus_i_1.o $(TOP_DIR)/build/sb_queue_base_Isolette_Data_Model_TempWstatus_i_1.o $(TOP_DIR)/build/sb_queue_base_Isolette_Data_Model_PhysicalTemp_i_1.o $(TOP_DIR)/build/sb_queue_base_Isolette_Environment_Heat_Type_1.o
...
$(TOP_DIR)/build/sb_queue_base_Isolette_Data_Model_Temp_i_1.o: $(TOP_DIR)/types/src/sb_queue_base_Isolette_Data_Model_Temp_i_1.c Makefile
	$(CC) -c $(CFLAGS) $< -o $@ $(TOP_INCLUDE)


$(TOP_DIR)/build/sb_queue_base_Isolette_Data_Model_Status_Type_1.o: $(TOP_DIR)/types/src/sb_queue_base_Isolette_Data_Model_Status_Type_1.c Makefile
	$(CC) -c $(CFLAGS) $< -o $@ $(TOP_INCLUDE)


$(TOP_DIR)/build/sb_queue_base_Isolette_Data_Model_Failure_Flag_i_1.o: $(TOP_DIR)/types/src/sb_queue_base_Isolette_Data_Model_Failure_Flag_i_1.c Makefile
	$(CC) -c $(CFLAGS) $< -o $@ $(TOP_INCLUDE)


$(TOP_DIR)/build/sb_queue_base_Isolette_Data_Model_On_Off_Type_1.o: $(TOP_DIR)/types/src/sb_queue_base_Isolette_Data_Model_On_Off_Type_1.c Makefile
	$(CC) -c $(CFLAGS) $< -o $@ $(TOP_INCLUDE)


$(TOP_DIR)/build/sb_queue_base_Isolette_Data_Model_Regulator_Mode_Type_1.o: $(TOP_DIR)/types/src/sb_queue_base_Isolette_Data_Model_Regulator_Mode_Type_1.c Makefile
	$(CC) -c $(CFLAGS) $< -o $@ $(TOP_INCLUDE)


$(TOP_DIR)/build/sb_queue_base_Isolette_Data_Model_Monitor_Mode_Type_1.o: $(TOP_DIR)/types/src/sb_queue_base_Isolette_Data_Model_Monitor_Mode_Type_1.c Makefile
	$(CC) -c $(CFLAGS) $< -o $@ $(TOP_INCLUDE)


$(TOP_DIR)/build/sb_queue_base_Isolette_Data_Model_TempWstatus_i_1.o: $(TOP_DIR)/types/src/sb_queue_base_Isolette_Data_Model_TempWstatus_i_1.c Makefile
	$(CC) -c $(CFLAGS) $< -o $@ $(TOP_INCLUDE)


$(TOP_DIR)/build/sb_queue_base_Isolette_Data_Model_PhysicalTemp_i_1.o: $(TOP_DIR)/types/src/sb_queue_base_Isolette_Data_Model_PhysicalTemp_i_1.c Makefile
	$(CC) -c $(CFLAGS) $< -o $@ $(TOP_INCLUDE)


$(TOP_DIR)/build/sb_queue_base_Isolette_Environment_Heat_Type_1.o: $(TOP_DIR)/types/src/sb_queue_base_Isolette_Environment_Heat_Type_1.c Makefile
	$(CC) -c $(CFLAGS) $< -o $@ $(TOP_INCLUDE)
