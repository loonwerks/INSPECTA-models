...
sb_queue_base_Isolette_Data_Model_Temp_i_1_Recv_t upper_desired_temp_recv_queue;
volatile sb_queue_base_Isolette_Data_Model_Temp_i_1_t *lower_desired_temp_queue_1;
sb_queue_base_Isolette_Data_Model_Temp_i_1_Recv_t lower_desired_temp_recv_queue;
...
base_Isolette_Data_Model_Temp_i last_upper_desired_temp_payload;

bool get_upper_desired_temp(base_Isolette_Data_Model_Temp_i *data) {
  sb_event_counter_t numDropped;
  base_Isolette_Data_Model_Temp_i fresh_data;
  bool isFresh = sb_queue_base_Isolette_Data_Model_Temp_i_1_dequeue((sb_queue_base_Isolette_Data_Model_Temp_i_1_Recv_t *) &upper_desired_temp_recv_queue, &numDropped, &fresh_data);
  if (isFresh) {
...
base_Isolette_Data_Model_Temp_i last_lower_desired_temp_payload;

bool get_lower_desired_temp(base_Isolette_Data_Model_Temp_i *data) {
  sb_event_counter_t numDropped;
  base_Isolette_Data_Model_Temp_i fresh_data;
  bool isFresh = sb_queue_base_Isolette_Data_Model_Temp_i_1_dequeue((sb_queue_base_Isolette_Data_Model_Temp_i_1_Recv_t *) &lower_desired_temp_recv_queue, &numDropped, &fresh_data);
  if (isFresh) {
...
bool put_heat_control(const base_Isolette_Data_Model_On_Off_Type *data) {
  sb_queue_base_Isolette_Data_Model_On_Off_Type_1_enqueue((sb_queue_base_Isolette_Data_Model_On_Off_Type_1_t *) heat_control_queue_1, (base_Isolette_Data_Model_On_Off_Type *) data);
...
void init(void) {
  sb_queue_base_Isolette_Data_Model_Temp_i_1_Recv_init(&upper_desired_temp_recv_queue, (sb_queue_base_Isolette_Data_Model_Temp_i_1_t *) upper_desired_temp_queue_1);

  sb_queue_base_Isolette_Data_Model_Temp_i_1_Recv_init(&lower_desired_temp_recv_queue, (sb_queue_base_Isolette_Data_Model_Temp_i_1_t *) lower_desired_temp_queue_1);

  sb_queue_base_Isolette_Data_Model_On_Off_Type_1_init((sb_queue_base_Isolette_Data_Model_On_Off_Type_1_t *) heat_control_queue_1);
