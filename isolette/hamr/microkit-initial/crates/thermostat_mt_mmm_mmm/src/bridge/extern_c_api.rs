...
extern "C" {
  ...
  fn put_monitor_mode(data: *mut Isolette_Data_Model::Monitor_Mode) -> bool;
...
pub fn unsafe_put_monitor_mode(data: &Isolette_Data_Model::Monitor_Mode) -> bool 
 {
   unsafe {
     return put_monitor_mode(data as *const Isolette_Data_Model::Monitor_Mode as *mut Isolette_Data_Model::Monitor_Mode);
   }
 }
...
#[cfg(test)]
pub fn put_monitor_mode(data: *mut Isolette_Data_Model::Monitor_Mode) -> bool 
 {
   unsafe {
     *OUT_monitor_mode.lock().unwrap() = Some(*data);
     return true;
   }
 }
