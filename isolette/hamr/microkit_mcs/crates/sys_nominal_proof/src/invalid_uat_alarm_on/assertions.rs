...
//! Place-assertion spec functions of property `invalid_uat_alarm_on` -- one per
...
/** property invalid_uat_alarm_on, bound 'after ma' (place after_ma)
  *   end-to-end: invalid upper alarm temp & past startup implies alarm on
  */
pub open spec fn sys_assert_invalid_uat_alarm_on_after_ma(st: SystemState) -> bool
{
  ((st.upper_alarm_tempWstatus.status != Isolette_Data_Model::ValueStatus::Valid) &&
