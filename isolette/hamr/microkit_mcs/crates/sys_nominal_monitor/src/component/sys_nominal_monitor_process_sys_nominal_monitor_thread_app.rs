...
impl sys_nominal_monitor_process_sys_nominal_monitor_thread {
    ...
    api: &mut sys_nominal_monitor_process_sys_nominal_monitor_thread_Application_Api<API>)
  {
    ...
    if visited & PLACE_AFTER_OI != 0 {
      if !(GUMBO_Library::Allowed_AlarmTempWStatus_Ranges(api.get_operator_interface_oip_oit_lower_alarm_tempWstatus(), api.get_operator_interface_oip_oit_upper_alarm_tempWstatus())) {
