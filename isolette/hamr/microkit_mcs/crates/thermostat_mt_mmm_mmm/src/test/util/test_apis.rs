...
/// getter for OUT DataPort
pub fn get_sv_lastMonitorMode() -> Isolette_Data_Model::Monitor_Mode
{
  return extern_api::OUT_sv_lastMonitorMode.lock().unwrap_or_else(|e| e.into_inner()).expect("Not expecting None")
}
