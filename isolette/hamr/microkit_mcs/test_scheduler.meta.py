...
def generate(sdf_path: str, output_dir: str, dtb: DeviceTree):
    ...
    test_controller_process_test_controller_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_lower_desired_temp_1_Memory_Region, 0x20_001_000, perms="rw"))
    ...
    test_controller_process_test_controller_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_displayed_temp_1_Memory_Region, 0x20_002_000, perms="rw"))
    ...
    test_controller_process_test_controller_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_regulator_status_1_Memory_Region, 0x20_003_000, perms="rw"))
    ...
    test_controller_process_test_controller_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_interface_failure_1_Memory_Region, 0x20_004_000, perms="rw"))
    ...
    test_controller_process_test_controller_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mhs_mhs_heat_control_1_Memory_Region, 0x20_005_000, perms="rw"))
    ...
    test_controller_process_test_controller_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mhs_mhs_sv_lastCmd_1_Memory_Region, 0x20_006_000, perms="rw"))
    ...
    test_controller_process_test_controller_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mrm_mrm_regulator_mode_1_Memory_Region, 0x20_007_000, perms="rw"))
    ...
    test_controller_process_test_controller_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mrm_mrm_sv_lastRegulatorMode_1_Memory_Region, 0x20_008_000, perms="rw"))
    ...
    test_controller_process_test_controller_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_drf_drf_internal_failure_1_Memory_Region, 0x20_009_000, perms="rw"))
    ...
    test_controller_process_test_controller_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_upper_alarm_temp_1_Memory_Region, 0x20_00A_000, perms="rw"))
    ...
    test_controller_process_test_controller_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_lower_alarm_temp_1_Memory_Region, 0x20_00B_000, perms="rw"))
    ...
    test_controller_process_test_controller_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_monitor_status_1_Memory_Region, 0x20_00C_000, perms="rw"))
    ...
    test_controller_process_test_controller_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_interface_failure_1_Memory_Region, 0x20_00D_000, perms="rw"))
    ...
    test_controller_process_test_controller_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_sv_lastCmd_1_Memory_Region, 0x20_00E_000, perms="rw"))
    ...
    test_controller_process_test_controller_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_ma_ma_alarm_control_1_Memory_Region, 0x20_00F_000, perms="rw"))
    ...
    test_controller_process_test_controller_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_ma_ma_sv_lastCmd_1_Memory_Region, 0x20_010_000, perms="rw"))
    ...
    test_controller_process_test_controller_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmm_mmm_monitor_mode_1_Memory_Region, 0x20_011_000, perms="rw"))
    ...
    test_controller_process_test_controller_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmm_mmm_sv_lastMonitorMode_1_Memory_Region, 0x20_012_000, perms="rw"))
    ...
    test_controller_process_test_controller_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_dmf_dmf_internal_failure_1_Memory_Region, 0x20_013_000, perms="rw"))
    ...
    test_controller_process_test_controller_thread.add_map(Map(Isolette_Single_Sensor_Instance_operator_interface_oip_oit_lower_desired_tempWstatus_1_Memory_Region, 0x20_014_000, perms="rw"))
    ...
    test_controller_process_test_controller_thread.add_map(Map(Isolette_Single_Sensor_Instance_operator_interface_oip_oit_upper_desired_tempWstatus_1_Memory_Region, 0x20_015_000, perms="rw"))
    ...
    test_controller_process_test_controller_thread.add_map(Map(Isolette_Single_Sensor_Instance_operator_interface_oip_oit_lower_alarm_tempWstatus_1_Memory_Region, 0x20_016_000, perms="rw"))
    ...
    test_controller_process_test_controller_thread.add_map(Map(Isolette_Single_Sensor_Instance_operator_interface_oip_oit_upper_alarm_tempWstatus_1_Memory_Region, 0x20_017_000, perms="rw"))
    ...
    test_controller_process_test_controller_thread.add_map(Map(Isolette_Single_Sensor_Instance_temperature_sensor_cpi_thermostat_current_tempWstatus_1_Memory_Region, 0x20_018_000, perms="rw"))
    ...
    test_controller_process_test_controller_thread.add_map(Map(Isolette_Single_Sensor_Instance_temperature_sensor_cpi_thermostat_air_1_Memory_Region, 0x20_019_000, perms="rw"))
    ...
    test_controller_process_test_controller_thread.add_map(Map(Isolette_Single_Sensor_Instance_heat_source_cpi_heat_controller_heat_out_1_Memory_Region, 0x20_01A_000, perms="rw"))
    ...
    thermostat_rt_mrm_mrm.add_map(Map(inj_thermostat_rt_mrm_mrm_sv_lastRegulatorMode, 0x20_801_000, perms="r", setvar_vaddr="inj_sv_lastRegulatorMode_queue"))
    test_controller_process_test_controller_thread.add_map(Map(inj_thermostat_rt_mrm_mrm_sv_lastRegulatorMode, 0x20_401_000, perms="rw"))
    thermostat_mt_mmi_mmi.add_map(Map(inj_thermostat_mt_mmi_mmi_sv_lastCmd, 0x20_802_000, perms="r", setvar_vaddr="inj_sv_lastCmd_queue"))
    test_controller_process_test_controller_thread.add_map(Map(inj_thermostat_mt_mmi_mmi_sv_lastCmd, 0x20_402_000, perms="rw"))
    thermostat_mt_ma_ma.add_map(Map(inj_thermostat_mt_ma_ma_sv_lastCmd, 0x20_803_000, perms="r", setvar_vaddr="inj_sv_lastCmd_queue"))
    test_controller_process_test_controller_thread.add_map(Map(inj_thermostat_mt_ma_ma_sv_lastCmd, 0x20_403_000, perms="rw"))
    thermostat_mt_mmm_mmm.add_map(Map(inj_thermostat_mt_mmm_mmm_sv_lastMonitorMode, 0x20_804_000, perms="r", setvar_vaddr="inj_sv_lastMonitorMode_queue"))
    test_controller_process_test_controller_thread.add_map(Map(inj_thermostat_mt_mmm_mmm_sv_lastMonitorMode, 0x20_404_000, perms="rw"))
