...
def generate(sdf_path: str, output_dir: str, dtb: DeviceTree):
    ...
    sys_nominal_monitor_process_sys_nominal_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_upper_desired_temp_1_Memory_Region, 0x10_000_000, perms="r", setvar_vaddr="thermostat_rt_mri_mri_upper_desired_temp_queue_1"))
    ...
    sys_nominal_monitor_process_sys_nominal_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_lower_desired_temp_1_Memory_Region, 0x10_001_000, perms="r", setvar_vaddr="thermostat_rt_mri_mri_lower_desired_temp_queue_1"))
    ...
    sys_nominal_monitor_process_sys_nominal_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_displayed_temp_1_Memory_Region, 0x10_002_000, perms="r", setvar_vaddr="thermostat_rt_mri_mri_displayed_temp_queue_1"))
    ...
    sys_nominal_monitor_process_sys_nominal_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_regulator_status_1_Memory_Region, 0x10_003_000, perms="r", setvar_vaddr="thermostat_rt_mri_mri_regulator_status_queue_1"))
    ...
    sys_nominal_monitor_process_sys_nominal_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mri_mri_interface_failure_1_Memory_Region, 0x10_004_000, perms="r", setvar_vaddr="thermostat_rt_mri_mri_interface_failure_queue_1"))
    ...
    sys_nominal_monitor_process_sys_nominal_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mhs_mhs_heat_control_1_Memory_Region, 0x10_005_000, perms="r", setvar_vaddr="thermostat_rt_mhs_mhs_heat_control_queue_1"))
    ...
    sys_nominal_monitor_process_sys_nominal_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mhs_mhs_sv_lastCmd_1_Memory_Region, 0x10_006_000, perms="r", setvar_vaddr="thermostat_rt_mhs_mhs_sv_lastCmd_queue_1"))
    ...
    sys_nominal_monitor_process_sys_nominal_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mrm_mrm_regulator_mode_1_Memory_Region, 0x10_007_000, perms="r", setvar_vaddr="thermostat_rt_mrm_mrm_regulator_mode_queue_1"))
    ...
    sys_nominal_monitor_process_sys_nominal_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_mrm_mrm_sv_lastRegulatorMode_1_Memory_Region, 0x10_008_000, perms="r", setvar_vaddr="thermostat_rt_mrm_mrm_sv_lastRegulatorMode_queue_1"))
    ...
    sys_nominal_monitor_process_sys_nominal_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_rt_drf_drf_internal_failure_1_Memory_Region, 0x10_009_000, perms="r", setvar_vaddr="thermostat_rt_drf_drf_internal_failure_queue_1"))
    ...
    sys_nominal_monitor_process_sys_nominal_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_upper_alarm_temp_1_Memory_Region, 0x10_00A_000, perms="r", setvar_vaddr="thermostat_mt_mmi_mmi_upper_alarm_temp_queue_1"))
    ...
    sys_nominal_monitor_process_sys_nominal_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_lower_alarm_temp_1_Memory_Region, 0x10_00B_000, perms="r", setvar_vaddr="thermostat_mt_mmi_mmi_lower_alarm_temp_queue_1"))
    ...
    sys_nominal_monitor_process_sys_nominal_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_monitor_status_1_Memory_Region, 0x10_00C_000, perms="r", setvar_vaddr="thermostat_mt_mmi_mmi_monitor_status_queue_1"))
    ...
    sys_nominal_monitor_process_sys_nominal_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_interface_failure_1_Memory_Region, 0x10_00D_000, perms="r", setvar_vaddr="thermostat_mt_mmi_mmi_interface_failure_queue_1"))
    ...
    sys_nominal_monitor_process_sys_nominal_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmi_mmi_sv_lastCmd_1_Memory_Region, 0x10_00E_000, perms="r", setvar_vaddr="thermostat_mt_mmi_mmi_sv_lastCmd_queue_1"))
    ...
    sys_nominal_monitor_process_sys_nominal_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_ma_ma_alarm_control_1_Memory_Region, 0x10_00F_000, perms="r", setvar_vaddr="thermostat_mt_ma_ma_alarm_control_queue_1"))
    ...
    sys_nominal_monitor_process_sys_nominal_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_ma_ma_sv_lastCmd_1_Memory_Region, 0x10_010_000, perms="r", setvar_vaddr="thermostat_mt_ma_ma_sv_lastCmd_queue_1"))
    ...
    sys_nominal_monitor_process_sys_nominal_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmm_mmm_monitor_mode_1_Memory_Region, 0x10_011_000, perms="r", setvar_vaddr="thermostat_mt_mmm_mmm_monitor_mode_queue_1"))
    ...
    sys_nominal_monitor_process_sys_nominal_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_mmm_mmm_sv_lastMonitorMode_1_Memory_Region, 0x10_012_000, perms="r", setvar_vaddr="thermostat_mt_mmm_mmm_sv_lastMonitorMode_queue_1"))
    ...
    sys_nominal_monitor_process_sys_nominal_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_thermostat_mt_dmf_dmf_internal_failure_1_Memory_Region, 0x10_013_000, perms="r", setvar_vaddr="thermostat_mt_dmf_dmf_internal_failure_queue_1"))
    ...
    sys_nominal_monitor_process_sys_nominal_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_operator_interface_oip_oit_lower_desired_tempWstatus_1_Memory_Region, 0x10_014_000, perms="r", setvar_vaddr="operator_interface_oip_oit_lower_desired_tempWstatus_queue_1"))
    ...
    sys_nominal_monitor_process_sys_nominal_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_operator_interface_oip_oit_upper_desired_tempWstatus_1_Memory_Region, 0x10_015_000, perms="r", setvar_vaddr="operator_interface_oip_oit_upper_desired_tempWstatus_queue_1"))
    ...
    sys_nominal_monitor_process_sys_nominal_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_operator_interface_oip_oit_lower_alarm_tempWstatus_1_Memory_Region, 0x10_016_000, perms="r", setvar_vaddr="operator_interface_oip_oit_lower_alarm_tempWstatus_queue_1"))
    ...
    sys_nominal_monitor_process_sys_nominal_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_operator_interface_oip_oit_upper_alarm_tempWstatus_1_Memory_Region, 0x10_017_000, perms="r", setvar_vaddr="operator_interface_oip_oit_upper_alarm_tempWstatus_queue_1"))
    ...
    sys_nominal_monitor_process_sys_nominal_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_temperature_sensor_cpi_thermostat_current_tempWstatus_1_Memory_Region, 0x10_018_000, perms="r", setvar_vaddr="temperature_sensor_cpi_thermostat_current_tempWstatus_queue_1"))
    ...
    sys_nominal_monitor_process_sys_nominal_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_temperature_sensor_cpi_thermostat_air_1_Memory_Region, 0x10_019_000, perms="r", setvar_vaddr="temperature_sensor_cpi_thermostat_air_queue_1"))
    ...
    sys_nominal_monitor_process_sys_nominal_monitor_thread.add_map(Map(sched_state, 0x10_01A_000, perms="r", setvar_vaddr="sched_state_queue_1"))
    sys_nominal_monitor_process_sys_nominal_monitor_thread.add_map(Map(sched_schedule, 0x10_01B_000, perms="r", setvar_vaddr="sched_schedule_queue_1"))
    ...
    channel_sys_nominal_monitor_process_sys_nominal_monitor_thread_MON = 15
    ...
    sdf.add_channel(Channel(a=scheduler, a_id=15, b=sys_nominal_monitor_process_sys_nominal_monitor_thread_MON, b_id=0))
