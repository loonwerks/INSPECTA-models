...
volatile sb_queue_Isolette_Data_Model_Regulator_Mode_1_t *inj_sv_lastRegulatorMode_queue;
sb_queue_Isolette_Data_Model_Regulator_Mode_1_Recv_t inj_sv_lastRegulatorMode_recv;

bool get_inj_sv_lastRegulatorMode(Isolette_Data_Model_Regulator_Mode *value) {
  if (inj_sv_lastRegulatorMode_queue == NULL) {
    return false;
  }
  sb_event_counter_t numDropped;
  return sb_queue_Isolette_Data_Model_Regulator_Mode_1_dequeue(&inj_sv_lastRegulatorMode_recv, &numDropped, value);
}

bool is_injection_enabled(void) {
  return inj_sv_lastRegulatorMode_queue != NULL;
}
...
void init(void) {
  ...
  if (inj_sv_lastRegulatorMode_queue != NULL) {
    sb_queue_Isolette_Data_Model_Regulator_Mode_1_Recv_init(&inj_sv_lastRegulatorMode_recv, (sb_queue_Isolette_Data_Model_Regulator_Mode_1_t *) inj_sv_lastRegulatorMode_queue);
  }
