...
def generate(sdf_path: str, output_dir: str, dtb: DeviceTree):
    ...
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(Isolette_Single_Sensor_Instance_temperature_sensor_cpi_thermostat_air_1_Memory_Region, 0x10_019_000, perms="r", setvar_vaddr="temperature_sensor_cpi_thermostat_air_queue_1"))
    ...
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(sched_state, 0x10_01A_000, perms="r", setvar_vaddr="sched_state_queue_1"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(sched_schedule, 0x10_01B_000, perms="r", setvar_vaddr="sched_schedule_queue_1"))
