 ...
 */
fn initialize_RegulatorStatusIsInitiallyInit(api_regulator_status: Status) -> bool {
...
fn compute_CEP_T_Assm(
    ...
    compute_spec_lower_is_not_higher_than_upper_assume(
 ...
 *   http://pub.santoslab.org/high-assurance/module-requirements/reading/FAA-DoT-Requirements-AR-08-32.pdf#page=108
 */
fn compute_case_REQ_MRI_5() -> bool {
    implies(true, true)
}
 ...
 *   http://pub.santoslab.org/high-assurance/module-requirements/reading/FAA-DoT-Requirements-AR-08-32.pdf#page=108
 */
fn compute_case_REQ_MRI_9() -> bool {
    implies(true, true)
}
...
fn compute_CEP_T_Case(
    ...
    compute_case_REQ_MRI_1(api_regulator_mode, api_regulator_status)
        ...
        & compute_case_REQ_MRI_7(
            api_lower_desired_tempWstatus,
            api_upper_desired_tempWstatus,
            api_interface_failure,
        )
        & compute_case_REQ_MRI_8(
            api_lower_desired_tempWstatus,
            api_upper_desired_tempWstatus,
            api_interface_failure,
            api_lower_desired_temp,
