...
@datatype class Config_SWArduPilot_Impl_ArduPilot_ArduPilot_PreState_Container(attempts: Z, verbose: B, additiveTypeFiltering: B, typeFilter: ISZ[SWArduPilot_Impl_ArduPilot_ArduPilot_PreState_Container_DataTypeId.Type], filter: SW.ArduPilot_Impl_ArduPilot_ArduPilot_PreState_Container => B) {}
...
@datatype class Config_SWArduPilot_Impl_ArduPilot_ArduPilot_PreState_Container_P(attempts: Z, verbose: B, filter: SW.ArduPilot_Impl_ArduPilot_ArduPilot_PreState_Container_P => B) {}

@datatype class Config_SWArduPilot_Impl_ArduPilot_ArduPilot_PreState_Container_PS(attempts: Z, verbose: B, filter: SW.ArduPilot_Impl_ArduPilot_ArduPilot_PreState_Container_PS => B) {}

@datatype class Config_SWArduPilot_Impl_ArduPilot_ArduPilot_PostState_Container(attempts: Z, verbose: B, additiveTypeFiltering: B, typeFilter: ISZ[SWArduPilot_Impl_ArduPilot_ArduPilot_PostState_Container_DataTypeId.Type], filter: SW.ArduPilot_Impl_ArduPilot_ArduPilot_PostState_Container => B) {}

@datatype class Config_SWArduPilot_Impl_ArduPilot_ArduPilot_PostState_Container_P(attempts: Z, verbose: B, filter: SW.ArduPilot_Impl_ArduPilot_ArduPilot_PostState_Container_P => B) {}

@datatype class Config_SWArduPilot_Impl_ArduPilot_ArduPilot_PostState_Container_PS(attempts: Z, verbose: B, filter: SW.ArduPilot_Impl_ArduPilot_ArduPilot_PostState_Container_PS => B) {}
...
@datatype class Config_SWLowLevelEthernetDriver_Impl_LowLevelEthernetDriver_LowLevelEthernetDriver_PreState_Container(attempts: Z, verbose: B, additiveTypeFiltering: B, typeFilter: ISZ[SWLowLevelEthernetDriver_Impl_LowLevelEthernetDriver_LowLevelEthernetDriver_PreState_Container_DataTypeId.Type], filter: SW.LowLevelEthernetDriver_Impl_LowLevelEthernetDriver_LowLevelEthernetDriver_PreState_Container => B) {}

@datatype class Config_SWLowLevelEthernetDriver_Impl_LowLevelEthernetDriver_LowLevelEthernetDriver_PreState_Container_P(attempts: Z, verbose: B, filter: SW.LowLevelEthernetDriver_Impl_LowLevelEthernetDriver_LowLevelEthernetDriver_PreState_Container_P => B) {}

@datatype class Config_SWLowLevelEthernetDriver_Impl_LowLevelEthernetDriver_LowLevelEthernetDriver_PreState_Container_PS(attempts: Z, verbose: B, filter: SW.LowLevelEthernetDriver_Impl_LowLevelEthernetDriver_LowLevelEthernetDriver_PreState_Container_PS => B) {}

@datatype class Config_SWLowLevelEthernetDriver_Impl_LowLevelEthernetDriver_LowLevelEthernetDriver_PostState_Container(attempts: Z, verbose: B, additiveTypeFiltering: B, typeFilter: ISZ[SWLowLevelEthernetDriver_Impl_LowLevelEthernetDriver_LowLevelEthernetDriver_PostState_Container_DataTypeId.Type], filter: SW.LowLevelEthernetDriver_Impl_LowLevelEthernetDriver_LowLevelEthernetDriver_PostState_Container => B) {}

@datatype class Config_SWLowLevelEthernetDriver_Impl_LowLevelEthernetDriver_LowLevelEthernetDriver_PostState_Container_P(attempts: Z, verbose: B, filter: SW.LowLevelEthernetDriver_Impl_LowLevelEthernetDriver_LowLevelEthernetDriver_PostState_Container_P => B) {}

@datatype class Config_SWLowLevelEthernetDriver_Impl_LowLevelEthernetDriver_LowLevelEthernetDriver_PostState_Container_PS(attempts: Z, verbose: B, filter: SW.LowLevelEthernetDriver_Impl_LowLevelEthernetDriver_LowLevelEthernetDriver_PostState_Container_PS => B) {}
