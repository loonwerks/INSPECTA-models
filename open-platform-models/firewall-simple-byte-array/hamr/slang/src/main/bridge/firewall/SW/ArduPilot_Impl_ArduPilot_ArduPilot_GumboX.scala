...
object ArduPilot_Impl_ArduPilot_ArduPilot_GumboX {
  ...
  /** IEP-Post: Initialize Entrypoint Post-Condition via container
    ...
    */
  @strictpure def inititialize_IEP_Post_Container (post: ArduPilot_Impl_ArduPilot_ArduPilot_PostState_Container_PS): B =
  ...
  /** CEP-Pre: Compute Entrypoint Pre-Condition for ArduPilot via container
    ...
    */
  @strictpure def compute_CEP_Pre_Container(pre: ArduPilot_Impl_ArduPilot_ArduPilot_PreState_Container_PS): B =
    compute_CEP_Pre(
  ...
  @strictpure def compute_CEP_Post_Container(
      pre: ArduPilot_Impl_ArduPilot_ArduPilot_PreState_Container_PS,
      post: ArduPilot_Impl_ArduPilot_ArduPilot_PostState_Container_PS): B =
    compute_CEP_Post(
      api_EthernetFramesRx = pre.api_EthernetFramesRx,
      api_EthernetFramesTx = post.api_EthernetFramesTx)
}
