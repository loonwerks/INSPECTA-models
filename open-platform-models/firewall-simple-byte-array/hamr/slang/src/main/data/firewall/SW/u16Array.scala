...
object u16Array {
  ...
  /** invariant __fixedArraySizeInvariant
    */
  @strictpure def __fixedArraySizeInvariant(value: SW.u16Array): B =
    value.value.size == 4


  /** D-Inv Data Invariant for SW.u16Array
    */
  @strictpure def D_Inv_u16Array(value: SW.u16Array): B =
    (__fixedArraySizeInvariant(value))

  /** D-Inv-Guard Data Invariant for SW.u16Array
    */
  @strictpure def D_Inv_Guard_u16Array(value: Option[SW.u16Array]): B =
    value.nonEmpty ___>: D_Inv_u16Array(value.get)
}

@datatype class u16Array(
  val value: IS[u16Array.I, U16]) {
  @spec def __fixedArraySizeInvariant = Invariant(value.size == 4)
}
