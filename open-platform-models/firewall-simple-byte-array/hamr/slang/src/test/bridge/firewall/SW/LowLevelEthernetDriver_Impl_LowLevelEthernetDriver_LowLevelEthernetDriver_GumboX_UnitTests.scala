...
import firewall.util.{Container, UnitTestConfigurationBatch}
import firewall.SW.LowLevelEthernetDriver_Impl_LowLevelEthernetDriver_LowLevelEthernetDriver_UnitTestConfiguration_Util._

// This file will not be overwritten so is safe to edit

class LowLevelEthernetDriver_Impl_LowLevelEthernetDriver_LowLevelEthernetDriver_GumboX_UnitTests extends LowLevelEthernetDriver_Impl_LowLevelEthernetDriver_LowLevelEthernetDriver_GumboX_TestHarness_ScalaTest {
