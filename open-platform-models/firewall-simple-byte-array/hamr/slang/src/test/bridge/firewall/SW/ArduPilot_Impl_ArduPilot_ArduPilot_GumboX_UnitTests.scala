...
import firewall.SW.ArduPilot_Impl_ArduPilot_ArduPilot_UnitTestConfiguration_Util._

// This file will not be overwritten so is safe to edit

class ArduPilot_Impl_ArduPilot_ArduPilot_GumboX_UnitTests extends ArduPilot_Impl_ArduPilot_ArduPilot_GumboX_TestHarness_ScalaTest {
