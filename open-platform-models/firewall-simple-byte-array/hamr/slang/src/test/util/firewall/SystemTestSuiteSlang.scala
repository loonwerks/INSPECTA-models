...
import firewall.SystemTestSuiteSlang._
import firewall.runtimemonitor.{GumboXDispatcher, ObservationKind, RuntimeMonitor, RuntimeMonitorListener}
...
@msig trait SystemTestSuiteSlang extends RuntimeMonitorListener {
  ...
  override def init(modelInfo: firewall.runtimemonitor.ModelInfo): Unit = {
  }
  ...
  override def observeComputePreState(bridgeId: art.Art.BridgeId, observationKind: firewall.runtimemonitor.ObservationKind.Type, pre: Option[art.DataContent]): Unit = {
