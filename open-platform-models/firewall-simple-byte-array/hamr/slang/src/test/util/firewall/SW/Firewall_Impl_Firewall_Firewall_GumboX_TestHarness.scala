...
@msig trait Firewall_Impl_Firewall_Firewall_GumboX_TestHarness extends Firewall_Impl_Firewall_Firewall_TestApi {
  ...
  def testInitialiseCB(
    ...
    val postResult = firewall.SW.Firewall_Impl_Firewall_Firewall_GumboX.inititialize_IEP_Post(api_EthernetFramesRxOut, api_EthernetFramesTxOut)
  ...
  def testComputeCB(
    ...
    val CEP_Pre_Result: B = firewall.SW.Firewall_Impl_Firewall_Firewall_GumboX.compute_CEP_Pre (api_EthernetFramesRxIn, api_EthernetFramesTxIn)
    if (!CEP_Pre_Result) {
