...
object Firewall_Impl_Firewall_Firewall_DSC_UnitTests extends App {
  def main(args: ISZ[String]): Z = {
    val instance = new Firewall_Impl_Firewall_Firewall_DSC_UnitTests()
    /*
    val c = instance.next()
...
class Firewall_Impl_Firewall_Firewall_DSC_UnitTests extends Firewall_Impl_Firewall_Firewall_GumboX_UnitTests
