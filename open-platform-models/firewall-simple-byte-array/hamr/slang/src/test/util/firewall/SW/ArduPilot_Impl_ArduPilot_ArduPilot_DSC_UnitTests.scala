...
object ArduPilot_Impl_ArduPilot_ArduPilot_DSC_UnitTests extends App {
  def main(args: ISZ[String]): Z = {
    val instance = new ArduPilot_Impl_ArduPilot_ArduPilot_DSC_UnitTests()
    /*
    val c = instance.next()
...
class ArduPilot_Impl_ArduPilot_ArduPilot_DSC_UnitTests extends ArduPilot_Impl_ArduPilot_ArduPilot_GumboX_UnitTests
