...
mod GUMBOX_tests {
  ...
  testComputeCB_macro! {
    ...
    api_EthernetFramesRxIn: generators::option_strategy_default(generators::SW_RawEthernetMessage_strategy_default()),
    api_EthernetFramesTxIn: generators::option_strategy_default(generators::SW_RawEthernetMessage_strategy_default())
  }
}
