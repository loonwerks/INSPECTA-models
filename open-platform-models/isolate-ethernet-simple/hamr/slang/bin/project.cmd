...
//     sireum proyek run . base.Demo
//
//   To see the available CLI options:
//     sireum proyek run . base.Demo -h
//
//   To run the example unit tests from the command line:
//     sireum proyek test .
//
//   To build an executable jar:
//     sireum proyek assemble --uber --main base.Demo .
//
// Sireum IVE:
//
...
//     Right click src/main/architecture/base/Demo.scala and choose "Run 'Demo'"
//
