...
import base.util.UnitTestConfiguration

// Do not edit this file as it will be overwritten if HAMR codegen is rerun

object LowLevelEthernetDriver_Impl_seL4_LowLevelEthernetDriver_LowLevelEthernetDriver_DSC_UnitTests extends App {
  def main(args: ISZ[String]): Z = {
    val instance = new LowLevelEthernetDriver_Impl_seL4_LowLevelEthernetDriver_LowLevelEthernetDriver_DSC_UnitTests()
    /*
    val c = instance.next()
...
class LowLevelEthernetDriver_Impl_seL4_LowLevelEthernetDriver_LowLevelEthernetDriver_DSC_UnitTests extends LowLevelEthernetDriver_Impl_seL4_LowLevelEthernetDriver_LowLevelEthernetDriver_GumboX_UnitTests
  ...
  override def toCompactJson(o: Container): String = {
    return base.JSON.fromutilContainer(o, T)
  }

  override def fromJson(json: String): Container = {
    base.JSON.toutilContainer(json) match {
  ...
  override def test(o: Container): B = {
    ...
    val r: B = getConfig().test(o) match {
      case GumboXResult.Pre_Condition_Unsat =>
        base.DSC_RecordUnsatPre.report(toCompactJson(o))
        T
