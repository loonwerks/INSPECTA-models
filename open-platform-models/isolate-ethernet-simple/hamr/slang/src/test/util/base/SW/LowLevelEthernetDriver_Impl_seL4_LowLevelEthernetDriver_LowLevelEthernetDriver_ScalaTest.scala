...
abstract class LowLevelEthernetDriver_Impl_seL4_LowLevelEthernetDriver_LowLevelEthernetDriver_ScalaTest extends
  AnyFunSuite with OneInstancePerTest with BeforeAndAfterEach with
  LowLevelEthernetDriver_Impl_seL4_LowLevelEthernetDriver_LowLevelEthernetDriver_TestApi {
