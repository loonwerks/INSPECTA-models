    ...
    Contract(
      ...
      Ensures(
        ...
        api.EthernetFramesRxIn.nonEmpty -->:
          (api.EthernetFramesRxIn.get.internetProtocol == SW.InternetProtocol.IPV6) ->: api.EthernetFramesRxOut.isEmpty,
        ...
        api.EthernetFramesRxIn.nonEmpty -->:
          (api.EthernetFramesRxIn.get.internetProtocol == SW.InternetProtocol.IPV6 &
            ...
            !(api.EthernetFramesRxIn.get.portIsWhitelisted)) ->: (api.EthernetFramesRxOut.isEmpty ||
        ...
        (api.EthernetFramesRxIn.nonEmpty -->:
           ...
           api.EthernetFramesRxIn.get.frameProtocol == SW.FrameProtocol.ARP) ->: (api.EthernetFramesTxOut.nonEmpty &&
        ...
        api.EthernetFramesRxIn.nonEmpty -->:
          (api.EthernetFramesRxIn.get.internetProtocol == SW.InternetProtocol.IPV4 &
            api.EthernetFramesRxIn.get.frameProtocol == SW.FrameProtocol.TCP &
            api.EthernetFramesRxIn.get.portIsWhitelisted) ->: (api.EthernetFramesRxOut.nonEmpty &&
        ...
        api.EthernetFramesTxIn.nonEmpty -->:
          (api.EthernetFramesTxIn.get.internetProtocol == SW.InternetProtocol.IPV4 |
            api.EthernetFramesTxIn.get.frameProtocol == SW.FrameProtocol.ARP) ->: (api.EthernetFramesTxOut.nonEmpty &&
