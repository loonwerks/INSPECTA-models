...
object Schedulers {
  ...
  val threadNickNames: Map[String, Art.BridgeId] = Map(
    ISZ(
      Arch.ZCU102_Impl_Instance_seL4_ArduPilot_ArduPilot.name ~> Arch.ZCU102_Impl_Instance_seL4_ArduPilot_ArduPilot.id,
      Arch.ZCU102_Impl_Instance_seL4_Firewall_Firewall.name ~> Arch.ZCU102_Impl_Instance_seL4_Firewall_Firewall.id,
      Arch.ZCU102_Impl_Instance_seL4_LowLevelEthernetDriver_LowLevelEthernetDriver.name ~> Arch.ZCU102_Impl_Instance_seL4_LowLevelEthernetDriver_LowLevelEthernetDriver.id)
  )
  ...
  val ZCU102_Impl_Instance_proc_timingProperties: ProcessorTimingProperties = ProcessorTimingProperties(
    clockPeriod = Some(2),
    framePeriod = Some(1000),
    maxDomain = Some(5),
    slotTime = None())

  val ZCU102_Impl_Instance_seL4_ArduPilot_ArduPilot_timingProperties: ThreadTimingProperties = ThreadTimingProperties(
    computeExecutionTime = Some((100, 100)),
    domain = Some(4))

  val ZCU102_Impl_Instance_seL4_Firewall_Firewall_timingProperties: ThreadTimingProperties = ThreadTimingProperties(
    computeExecutionTime = Some((100, 100)),
    domain = Some(3))

  val ZCU102_Impl_Instance_seL4_LowLevelEthernetDriver_LowLevelEthernetDriver_timingProperties: ThreadTimingProperties = ThreadTimingProperties(
    computeExecutionTime = Some((100, 100)),
    domain = Some(2))
  ...
  val defaultDomainToBridgeIdMap: ISZ[Art.BridgeId] = ISZ(
    /* domain 0 */ Arch.ZCU102_Impl_Instance_seL4_ArduPilot_ArduPilot.id,
    /* domain 1 */ Arch.ZCU102_Impl_Instance_seL4_Firewall_Firewall.id,
    /* domain 2 */ Arch.ZCU102_Impl_Instance_seL4_LowLevelEthernetDriver_LowLevelEthernetDriver.id
  )
