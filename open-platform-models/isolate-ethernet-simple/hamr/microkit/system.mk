...
TYPE_OBJS := $(TOP_DIR)/build/sb_queue_SW_StructuredEthernetMessage_i_1.o
...
seL4_ArduPilot_ArduPilot.elf: $(UTIL_OBJS) seL4_ArduPilot_ArduPilot_rust seL4_ArduPilot_ArduPilot.o $(TYPES_LIB)
	$(LD) $(LDFLAGS) -L ${CRATES_DIR}/seL4_ArduPilot_ArduPilot/target/aarch64-unknown-none/$(RUST_PROFILE_DIR) $(filter %.o, $^) $(TYPES_LIB) $(LIBS) -lseL4_ArduPilot_ArduPilot -o $@

seL4_Firewall_Firewall_MON.elf: seL4_Firewall_Firewall_MON.o
	$(LD) $(LDFLAGS) $^ $(LIBS) -o $@

seL4_Firewall_Firewall.elf: $(UTIL_OBJS) seL4_Firewall_Firewall_rust seL4_Firewall_Firewall.o $(TYPES_LIB)
	$(LD) $(LDFLAGS) -L ${CRATES_DIR}/seL4_Firewall_Firewall/target/aarch64-unknown-none/$(RUST_PROFILE_DIR) $(filter %.o, $^) $(TYPES_LIB) $(LIBS) -lseL4_Firewall_Firewall -o $@

seL4_LowLevelEthernetDriver_LowLevelEthernetDriver_MON.elf: seL4_LowLevelEthernetDriver_LowLevelEthernetDriver_MON.o
	$(LD) $(LDFLAGS) $^ $(LIBS) -o $@

seL4_LowLevelEthernetDriver_LowLevelEthernetDriver.elf: $(UTIL_OBJS) seL4_LowLevelEthernetDriver_LowLevelEthernetDriver_rust seL4_LowLevelEthernetDriver_LowLevelEthernetDriver.o $(TYPES_LIB)
	$(LD) $(LDFLAGS) -L ${CRATES_DIR}/seL4_LowLevelEthernetDriver_LowLevelEthernetDriver/target/aarch64-unknown-none/$(RUST_PROFILE_DIR) $(filter %.o, $^) $(TYPES_LIB) $(LIBS) -lseL4_LowLevelEthernetDriver_LowLevelEthernetDriver -o $@
