  ...
  impl seL4_Firewall_Firewall {
    ...
    pub fn timeTriggered<API: seL4_Firewall_Firewall_Full_Api>(
      ...
      ensures
        ...
        api.EthernetFramesRxIn.is_some() ==> api.EthernetFramesRxIn.unwrap().internetProtocol == SW::InternetProtocol::IPV6 ==> api.EthernetFramesRxOut.is_none(),
        ...
        api.EthernetFramesRxIn.is_some() ==> (api.EthernetFramesRxIn.unwrap().internetProtocol == SW::InternetProtocol::IPV6 &&
          api.EthernetFramesRxIn.unwrap().frameProtocol == SW::FrameProtocol::TCP &&
          !(api.EthernetFramesRxIn.unwrap().portIsWhitelisted)) ==> (api.EthernetFramesRxOut.is_none() ||
        ...
        (api.EthernetFramesRxIn.is_some() ==> (api.EthernetFramesRxIn.unwrap().internetProtocol == SW::InternetProtocol::IPV4) &&
          api.EthernetFramesRxIn.unwrap().frameProtocol == SW::FrameProtocol::ARP) ==> (api.EthernetFramesTxOut.is_some() &&
        ...
        api.EthernetFramesRxIn.is_some() ==> (api.EthernetFramesRxIn.unwrap().internetProtocol == SW::InternetProtocol::IPV4 &&
          api.EthernetFramesRxIn.unwrap().frameProtocol == SW::FrameProtocol::TCP &&
          api.EthernetFramesRxIn.unwrap().portIsWhitelisted) ==> (api.EthernetFramesRxOut.is_some() &&
        ...
        api.EthernetFramesTxIn.is_some() ==> (api.EthernetFramesTxIn.unwrap().internetProtocol == SW::InternetProtocol::IPV4 ||
          api.EthernetFramesTxIn.unwrap().frameProtocol == SW::FrameProtocol::ARP) ==> (api.EthernetFramesTxOut.is_some() &&
