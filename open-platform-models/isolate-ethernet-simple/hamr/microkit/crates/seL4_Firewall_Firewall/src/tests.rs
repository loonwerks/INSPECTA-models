...
mod GUMBOX_tests {
  ...
  testComputeCB_macro! {
    ...
    api_EthernetFramesRxIn: test_api::option_strategy_default(test_api::SW_StructuredEthernetMessage_i_strategy_default()),
    api_EthernetFramesTxIn: test_api::option_strategy_default(test_api::SW_StructuredEthernetMessage_i_strategy_default())
  }
