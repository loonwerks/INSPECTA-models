...
pub closed spec fn spec_mavlink_v2_msg_payload(msgid: u24, len: u8) -> SpecMavlinkV2MsgPayloadCombinator {
...
pub closed spec fn spec_mavlink_v2_msg_signature(incompat_flags: u8) -> SpecMavlinkV2MsgSignatureCombinator {
