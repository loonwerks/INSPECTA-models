...
pub fn get_EthernetFramesTx0() -> Option<SW::RawEthernetMessage> 
 {
   return extern_api::OUT_EthernetFramesTx0.lock().unwrap().clone()
 }

pub fn get_EthernetFramesTx1() -> Option<SW::RawEthernetMessage> 
 {
   return extern_api::OUT_EthernetFramesTx1.lock().unwrap().clone()
 }

pub fn get_EthernetFramesTx2() -> Option<SW::RawEthernetMessage> 
 {
   return extern_api::OUT_EthernetFramesTx2.lock().unwrap().clone()
 }

pub fn get_EthernetFramesTx3() -> Option<SW::RawEthernetMessage> 
 {
   return extern_api::OUT_EthernetFramesTx3.lock().unwrap().clone()
 }
...
pub fn put_EthernetFramesRx0(value: Option<SW::RawEthernetMessage>) 
 {
   *extern_api::IN_EthernetFramesRx0.lock().unwrap() = value
 }

pub fn put_EthernetFramesRx1(value: Option<SW::RawEthernetMessage>) 
 {
   *extern_api::IN_EthernetFramesRx1.lock().unwrap() = value
 }

pub fn put_EthernetFramesRx2(value: Option<SW::RawEthernetMessage>) 
 {
   *extern_api::IN_EthernetFramesRx2.lock().unwrap() = value
 }

pub fn put_EthernetFramesRx3(value: Option<SW::RawEthernetMessage>) 
 {
   *extern_api::IN_EthernetFramesRx3.lock().unwrap() = value
 }