...
impl seL4_MavlinkFirewall_MavlinkFirewall {
    ...
    pub fn timeTriggered<API: seL4_MavlinkFirewall_MavlinkFirewall_Full_Api> (
      ...
      ensures
        ...
        api.In0.is_some() && Self::msg_is_mav_cmd_flash_bootloader(api.In0.unwrap().payload) ==>
          api.Out0.is_none(),
...
// BEGIN MARKER GUMBO METHODS
    ...
    {
      Self::three_bytes_to_u32(msg[7],msg[8],msg[9]) == 75u32
    }
    ...
    {
      Self::three_bytes_to_u32(msg[7],msg[8],msg[9]) == 76u32
    }
    ...
    {
      Self::msg_is_mavlinkv2(msg) &&
        (Self::msg_v2_is_command_int(msg) && Self::command_int_msg_v2_is_bootloader_flash(msg) ||
          Self::msg_v2_is_command_long(msg) && Self::command_long_msg_v2_is_bootloader_flash(msg))
    }

    pub open spec fn msg_is_mav_v1_cmd_flash_bootloader(msg: SW::UdpPayload) -> bool
    {
      Self::msg_is_mavlinkv1(msg) &&
        (Self::msg_v1_is_command_int(msg) && Self::command_int_msg_v1_is_bootloader_flash(msg) ||
          Self::msg_v1_is_command_long(msg) && Self::command_long_msg_v1_is_bootloader_flash(msg))
    }

    pub open spec fn msg_is_mav_cmd_flash_bootloader(msg: SW::UdpPayload) -> bool
    {
      Self::msg_is_mav_v2_cmd_flash_bootloader(msg) || Self::msg_is_mav_v1_cmd_flash_bootloader(msg)
    }
    ...
    pub open spec fn mav_input_eq_output(
      ...
      frame: SW::RawEthernetMessage) -> bool
    {
      Self::mav_input_headers_eq_output(input.headers,frame) && Self::mav_input_payload_eq_output(input.payload,input.headers,frame)
    }

    pub open spec fn msg_is_blacklisted(msg: SW::UdpPayload) -> bool
    {
      Self::msg_is_mav_cmd_flash_bootloader(msg)
    }
