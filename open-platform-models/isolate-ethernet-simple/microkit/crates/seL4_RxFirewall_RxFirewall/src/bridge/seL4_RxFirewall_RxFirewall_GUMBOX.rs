...
pub fn udp_is_mavlink_port(frame: SW::RawEthernetMessage) -> bool {
    two_bytes_to_u16(frame[36], frame[37]) == 14550
}

pub fn frame_has_ipv4_tcp_on_allowed_port_quant(frame: SW::RawEthernetMessage) -> bool {
    (0..TCP_ALLOWED_PORTS().len())
        .any(|i| TCP_ALLOWED_PORTS()[i] == two_bytes_to_u16(frame[36], frame[37]))
}

pub fn frame_has_ipv4_udp_on_allowed_port_quant(frame: SW::RawEthernetMessage) -> bool {
    (0..UDP_ALLOWED_PORTS().len())
        .any(|i| UDP_ALLOWED_PORTS()[i] == two_bytes_to_u16(frame[36], frame[37]))
}
...
pub fn input_eq_mav_output(frame: SW::RawEthernetMessage, output: SW::UdpFrame_Impl) -> bool {
    true
}
...
pub fn compute_spec_hlr_18_rx0_can_send_mavlink_udp_guarantee(
    ...
    impliesL!(
        api_EthernetFramesRxIn0.is_some()
            && valid_ipv4_udp_mavlink(api_EthernetFramesRxIn0.unwrap()),
        api_MavlinkOut0.is_some()
            && input_eq_mav_output(api_EthernetFramesRxIn0.unwrap(), api_MavlinkOut0.unwrap())
            && api_VmmOut0.is_none()
    )
}
...
pub fn compute_spec_hlr_18_rx1_can_send_mavlink_udp_guarantee(
    ...
    impliesL!(
        api_EthernetFramesRxIn1.is_some()
            && valid_ipv4_udp_mavlink(api_EthernetFramesRxIn1.unwrap()),
        api_MavlinkOut1.is_some()
            && input_eq_mav_output(api_EthernetFramesRxIn1.unwrap(), api_MavlinkOut1.unwrap())
            && api_VmmOut1.is_none()
    )
}
...
pub fn compute_spec_hlr_18_rx2_can_send_mavlink_udp_guarantee(
    ...
    impliesL!(
        api_EthernetFramesRxIn2.is_some()
            && valid_ipv4_udp_mavlink(api_EthernetFramesRxIn2.unwrap()),
        api_MavlinkOut2.is_some()
            && input_eq_mav_output(api_EthernetFramesRxIn2.unwrap(), api_MavlinkOut2.unwrap())
            && api_VmmOut2.is_none()
    )
}
...
pub fn compute_spec_hlr_05_rx3_can_send_arp_to_vmm_guarantee(
    ...
    api_VmmOut3: Option<SW::RawEthernetMessage>,
) -> bool {
    impliesL!(
...
pub fn compute_spec_hlr_18_rx3_can_send_mavlink_udp_guarantee(
    ...
    impliesL!(
        api_EthernetFramesRxIn3.is_some()
            && valid_ipv4_udp_mavlink(api_EthernetFramesRxIn3.unwrap()),
        api_MavlinkOut3.is_some()
            && input_eq_mav_output(api_EthernetFramesRxIn3.unwrap(), api_MavlinkOut3.unwrap())
            && api_VmmOut3.is_none()
    )
}
...
pub fn compute_CEP_T_Guar(
    ...
    let r0: bool = compute_spec_hlr_05_rx0_can_send_arp_to_vmm_guarantee(
        api_EthernetFramesRxIn0,
        api_MavlinkOut0,
        api_VmmOut0,
    );
    let r1: bool = compute_spec_hlr_18_rx0_can_send_mavlink_udp_guarantee(
        api_EthernetFramesRxIn0,
        api_MavlinkOut0,
        api_VmmOut0,
    );
    ...
    let r5: bool = compute_spec_hlr_05_rx1_can_send_arp_to_vmm_guarantee(
        api_EthernetFramesRxIn1,
        api_MavlinkOut1,
        api_VmmOut1,
    );
    let r6: bool = compute_spec_hlr_18_rx1_can_send_mavlink_udp_guarantee(
        api_EthernetFramesRxIn1,
        api_MavlinkOut1,
        api_VmmOut1,
    );
    ...
    let r10: bool = compute_spec_hlr_05_rx2_can_send_arp_to_vmm_guarantee(
        api_EthernetFramesRxIn2,
        api_MavlinkOut2,
        api_VmmOut2,
    );
    let r11: bool = compute_spec_hlr_18_rx2_can_send_mavlink_udp_guarantee(
        api_EthernetFramesRxIn2,
        api_MavlinkOut2,
        api_VmmOut2,
    );
    ...
    let r15: bool = compute_spec_hlr_05_rx3_can_send_arp_to_vmm_guarantee(
        api_EthernetFramesRxIn3,
        api_MavlinkOut3,
        api_VmmOut3,
    );
    let r16: bool = compute_spec_hlr_18_rx3_can_send_mavlink_udp_guarantee(
        api_EthernetFramesRxIn3,
        api_MavlinkOut3,
        api_VmmOut3,
    );
