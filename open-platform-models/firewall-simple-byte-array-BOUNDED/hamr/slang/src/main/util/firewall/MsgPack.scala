...
// This file is auto-generated from RawEthernetMessage.scala, u16Array.scala, Base_Types.scala, Firewall_Impl_Firewall_Firewall_Containers.scala, Container.scala, DataContent.scala, Aux_Types.scala
...
object MsgPack {
  ...
  object Constants {
    ...
    val SWFirewall_Impl_Firewall_Firewall_PreState_Container_P: Z = -12

    val SWFirewall_Impl_Firewall_Firewall_PreState_Container_PS: Z = -11

    val SWFirewall_Impl_Firewall_Firewall_PostState_Container_P: Z = -10

    val SWFirewall_Impl_Firewall_Firewall_PostState_Container_PS: Z = -9

    val utilEmptyContainer: Z = -8
