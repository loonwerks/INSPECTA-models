...
//     sireum proyek run . firewall.Demo
//
//   To see the available CLI options:
//     sireum proyek run . firewall.Demo -h
//
//   To run the example unit tests from the command line:
//     sireum proyek test .
//
//   To build an executable jar:
//     sireum proyek assemble --uber --main firewall.Demo .
//
// Sireum IVE:
//
...
//     Right click src/main/architecture/firewall/Demo.scala and choose "Run 'Demo'"
//
