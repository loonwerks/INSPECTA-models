...
// This file is auto-generated from RawEthernetMessage.scala, Base_Types.scala, DataContent.scala, Aux_Types.scala
  ...
  @record class Parser(val input: String) {
    ...
    def parse_artDataContent(): art.DataContent = {
      ...
      t.native match {
        ...
        case _ => val r = parseSWRawEthernetMessage_PayloadT(T); return r
      }
    }
