  ...
  api_Out0: Option<SW::RawEthernetMessage>) -> bool
{
  impliesL!(
    api_In0.is_some() && msg_is_wellformed(api_In0.unwrap().payload) &&
      msg_is_mav_cmd_flash_bootloader(api_In0.unwrap().payload),
    api_Out0.is_none())
}
  ...
  api_Out0: Option<SW::RawEthernetMessage>) -> bool
{
  impliesL!(
    api_In0.is_some() && msg_is_wellformed(api_In0.unwrap().payload) &&
      !(msg_is_blacklisted(api_In0.unwrap().payload)),
  ...
  api_Out1: Option<SW::RawEthernetMessage>) -> bool
{
  impliesL!(
    api_In1.is_some() && msg_is_wellformed(api_In1.unwrap().payload) &&
      msg_is_mav_cmd_flash_bootloader(api_In1.unwrap().payload),
    api_Out1.is_none())
}
  ...
  api_Out1: Option<SW::RawEthernetMessage>) -> bool
{
  impliesL!(
    api_In1.is_some() && msg_is_wellformed(api_In1.unwrap().payload) &&
      !(msg_is_blacklisted(api_In1.unwrap().payload)),
  ...
  api_Out2: Option<SW::RawEthernetMessage>) -> bool
{
  impliesL!(
    api_In2.is_some() && msg_is_wellformed(api_In2.unwrap().payload) &&
      msg_is_mav_cmd_flash_bootloader(api_In2.unwrap().payload),
    api_Out2.is_none())
}
  ...
  api_Out2: Option<SW::RawEthernetMessage>) -> bool
{
  impliesL!(
    api_In2.is_some() && msg_is_wellformed(api_In2.unwrap().payload) &&
      !(msg_is_blacklisted(api_In2.unwrap().payload)),
  ...
  api_Out3: Option<SW::RawEthernetMessage>) -> bool
{
  impliesL!(
    api_In3.is_some() && msg_is_wellformed(api_In3.unwrap().payload) &&
      msg_is_mav_cmd_flash_bootloader(api_In3.unwrap().payload),
    api_Out3.is_none())
}
  ...
  api_Out3: Option<SW::RawEthernetMessage>) -> bool
{
  impliesL!(
    api_In3.is_some() && msg_is_wellformed(api_In3.unwrap().payload) &&
      !(msg_is_blacklisted(api_In3.unwrap().payload)),
