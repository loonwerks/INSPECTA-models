...
// SB_QUEUE_SW_UDPFRAME_IMPL_1_SIZE-1 elements.
#define SB_QUEUE_SW_UDPFRAME_IMPL_1_SIZE 2
...
typedef struct sb_queue_SW_UdpFrame_Impl_1 {
  ...
  // Queue of elements of type SW_UdpFrame_Impl
  // (see sb_types.h) implemented as a ring buffer.
  // No initialization necessary.
  SW_UdpFrame_Impl elt[SB_QUEUE_SW_UDPFRAME_IMPL_1_SIZE];

} sb_queue_SW_UdpFrame_Impl_1_t;
...
void sb_queue_SW_UdpFrame_Impl_1_init(sb_queue_SW_UdpFrame_Impl_1_t *queue);

// Enqueue data. This always succeeds and never blocks. Data is copied.
void sb_queue_SW_UdpFrame_Impl_1_enqueue(
  sb_queue_SW_UdpFrame_Impl_1_t *queue,
  SW_UdpFrame_Impl *data);
...
typedef struct sb_queue_SW_UdpFrame_Impl_1_Recv {
...
} sb_queue_SW_UdpFrame_Impl_1_Recv_t;

// Each receiver must call this exactly once before any calls to other queue
// API functions.
void sb_queue_SW_UdpFrame_Impl_1_Recv_init(
  sb_queue_SW_UdpFrame_Impl_1_Recv_t *recvQueue,
  sb_queue_SW_UdpFrame_Impl_1_t *queue);
...
// dropped since the last call to sb_queue_SW_UdpFrame_Impl_1_dequeue(). *data is left in
// unspecified state.
//
// If the sender ever gets ahead of a receiver by more than COUNTER_MAX,
// sb_queue_SW_UdpFrame_Impl_1_dequeue will fail to count a multiple of COUNTER_MAX in
...
bool sb_queue_SW_UdpFrame_Impl_1_dequeue(
  sb_queue_SW_UdpFrame_Impl_1_Recv_t *recvQueue,
...
bool sb_queue_SW_UdpFrame_Impl_1_is_empty(sb_queue_SW_UdpFrame_Impl_1_Recv_t *recvQueue);
