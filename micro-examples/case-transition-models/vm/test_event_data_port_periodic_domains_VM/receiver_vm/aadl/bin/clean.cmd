...
val toKeep: ISZ[Keep] = ISZ(
  ...
  KeepPath(camkes_sel4Dir / "components" / "VM" / "apps" / "vmconsumer" / "vm_utils.c"),
  KeepPath(camkes_sel4Dir / "components" / "VM" / "apps" / "vmconsumer" / "vm_utils.h"),
  KeepPath(camkes_sel4Dir / "components" / "VM" / "apps" / "vmconsumer" / "vmconsumer.c"),
