...
val packageName: String = "temp_control"
...
var codegenArgs: ISZ[String] = ISZ(
  ...
  "--system-name", "TempControl_SysVerif::TempControlSystem",
)

codegenArgs = codegenArgs ++ Os.cliArgs

codegenArgs = codegenArgs :+ (sysmlDir / "TempControl_SysVerif.sysml").value
