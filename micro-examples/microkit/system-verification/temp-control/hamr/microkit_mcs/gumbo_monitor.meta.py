...
def generate(sdf_path: str, output_dir: str, dtb: DeviceTree):
    ...
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(TempControlSystem_Instance_tsp_tst_currentTemp_1_Memory_Region, 0x10_000_000, perms="r", setvar_vaddr="tsp_tst_currentTemp_queue_1"))
    ...
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(TempControlSystem_Instance_tcp_tct_fanCmd_1_Memory_Region, 0x10_002_000, perms="r", setvar_vaddr="tcp_tct_fanCmd_queue_1"))
    tcp_tct.add_map(Map(TempControlSystem_Instance_tcp_tct_sv_currentSetPoint_1_Memory_Region, 0x10_004_000, perms="rw", setvar_vaddr="sv_currentSetPoint_queue_1"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(TempControlSystem_Instance_tcp_tct_sv_currentSetPoint_1_Memory_Region, 0x10_004_000, perms="r", setvar_vaddr="tcp_tct_sv_currentSetPoint_queue_1"))
    tcp_tct.add_map(Map(TempControlSystem_Instance_tcp_tct_sv_currentFanState_1_Memory_Region, 0x10_006_000, perms="rw", setvar_vaddr="sv_currentFanState_queue_1"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(TempControlSystem_Instance_tcp_tct_sv_currentFanState_1_Memory_Region, 0x10_006_000, perms="r", setvar_vaddr="tcp_tct_sv_currentFanState_queue_1"))
    tcp_tct.add_map(Map(TempControlSystem_Instance_tcp_tct_sv_latestTemp_1_Memory_Region, 0x10_008_000, perms="rw", setvar_vaddr="sv_latestTemp_queue_1"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(TempControlSystem_Instance_tcp_tct_sv_latestTemp_1_Memory_Region, 0x10_008_000, perms="r", setvar_vaddr="tcp_tct_sv_latestTemp_queue_1"))
    tcp_tct.add_map(Map(TempControlSystem_Instance_tcp_tct_sv_fanError_1_Memory_Region, 0x10_00A_000, perms="rw", setvar_vaddr="sv_fanError_queue_1"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(TempControlSystem_Instance_tcp_tct_sv_fanError_1_Memory_Region, 0x10_00A_000, perms="r", setvar_vaddr="tcp_tct_sv_fanError_queue_1"))
    tcp_tct.add_map(Map(TempControlSystem_Instance_tcp_tct_setPoint_1_Memory_Region, 0x10_00C_000, perms="r", setvar_vaddr="setPoint_queue_1"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(TempControlSystem_Instance_tcp_tct_setPoint_1_Memory_Region, 0x10_00E_000, perms="r", setvar_vaddr="tcp_tct_setPoint_queue_1"))
    tcp_tct.add_map(Map(TempControlSystem_Instance_fp_ft_fanAck_1_Memory_Region, 0x10_00E_000, perms="r", setvar_vaddr="fanAck_queue_1"))
    ...
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(TempControlSystem_Instance_fp_ft_fanAck_1_Memory_Region, 0x10_00C_000, perms="r", setvar_vaddr="fp_ft_fanAck_queue_1"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(sched_state, 0x10_010_000, perms="r", setvar_vaddr="sched_state_queue_1"))
    gumbo_monitor_process_gumbo_monitor_thread.add_map(Map(sched_schedule, 0x10_012_000, perms="r", setvar_vaddr="sched_schedule_queue_1"))
    ...
    channel_fp_ft_MON = 4
    channel_gumbo_monitor_process_gumbo_monitor_thread_MON = 6
    ...
    sdf.add_channel(Channel(a=scheduler, a_id=6, b=gumbo_monitor_process_gumbo_monitor_thread_MON, b_id=0))
