...
def generate(sdf_path: str, output_dir: str, dtb: DeviceTree):
    ...
    userland_monitor_process_userland_monitor_thread.add_map(Map(TempControlSystem_Instance_tsp_tst_currentTemp_1_Memory_Region, 0x10_000_000, perms="r", setvar_vaddr="tsp_tst_currentTemp_queue_1"))
    ...
    userland_monitor_process_userland_monitor_thread.add_map(Map(TempControlSystem_Instance_tcp_tct_fanCmd_1_Memory_Region, 0x10_001_000, perms="r", setvar_vaddr="tcp_tct_fanCmd_queue_1"))
    ...
    userland_monitor_process_userland_monitor_thread.add_map(Map(TempControlSystem_Instance_tcp_tct_setPoint_1_Memory_Region, 0x10_003_000, perms="r", setvar_vaddr="tcp_tct_setPoint_queue_1"))
    ...
    userland_monitor_process_userland_monitor_thread.add_map(Map(TempControlSystem_Instance_fp_ft_fanAck_1_Memory_Region, 0x10_002_000, perms="r", setvar_vaddr="fp_ft_fanAck_queue_1"))
    userland_monitor_process_userland_monitor_thread.add_map(Map(sched_state, 0x10_004_000, perms="r", setvar_vaddr="sched_state_queue_1"))
    userland_monitor_process_userland_monitor_thread.add_map(Map(sched_schedule, 0x10_005_000, perms="r", setvar_vaddr="sched_schedule_queue_1"))
    ...
    channel_fp_ft_MON = 4
    channel_userland_monitor_process_userland_monitor_thread_MON = 5
    ...
    sdf.add_channel(Channel(a=scheduler, a_id=5, b=userland_monitor_process_userland_monitor_thread_MON, b_id=0))
