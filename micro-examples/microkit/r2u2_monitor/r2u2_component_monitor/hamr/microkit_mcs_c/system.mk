...
# R2U2 monitor for consumer_consumer
CONSUMER_CONSUMER_R2U2_BUILD_DIR := r2u2/consumer_consumer
CONSUMER_CONSUMER_R2U2_OBJ_DIR := $(CONSUMER_CONSUMER_R2U2_BUILD_DIR)/obj
CONSUMER_CONSUMER_R2U2_BOUNDS := $(CONSUMER_CONSUMER_R2U2_BUILD_DIR)/bounds.h
CONSUMER_CONSUMER_R2U2_SPEC_BIN := $(CONSUMER_CONSUMER_R2U2_BUILD_DIR)/spec.bin
CONSUMER_CONSUMER_R2U2_SPEC_C := $(CONSUMER_CONSUMER_R2U2_BUILD_DIR)/spec_bin.c
CONSUMER_CONSUMER_R2U2_CPPFLAGS := $(R2U2_CPPFLAGS) -include $(CONSUMER_CONSUMER_R2U2_BOUNDS)
CONSUMER_CONSUMER_R2U2_RUNTIME_OBJS := $(addprefix $(CONSUMER_CONSUMER_R2U2_OBJ_DIR)/,$(R2U2_RUNTIME_REL_SRCS:.c=.o))
CONSUMER_CONSUMER_R2U2_OBJS := $(CONSUMER_CONSUMER_R2U2_RUNTIME_OBJS) \
	$(CONSUMER_CONSUMER_R2U2_OBJ_DIR)/r2u2_monitor.o \
	$(CONSUMER_CONSUMER_R2U2_OBJ_DIR)/spec_bin.o

$(CONSUMER_CONSUMER_R2U2_SPEC_BIN): $(TOP_DIR)/components/consumer_consumer/src/spec.c2po $(TOP_DIR)/components/consumer_consumer/src/spec.map Makefile | r2u2_cli
	mkdir -p "$(CONSUMER_CONSUMER_R2U2_BUILD_DIR)"
	sed '/^--/d' "$(TOP_DIR)/components/consumer_consumer/src/spec.map" > "$(CONSUMER_CONSUMER_R2U2_BUILD_DIR)/temp.map"
	r2u2_cli compile --disable-aux -o "$(CONSUMER_CONSUMER_R2U2_BUILD_DIR)" -b "$(CONSUMER_CONSUMER_R2U2_BOUNDS)" "$(TOP_DIR)/components/consumer_consumer/src/spec.c2po" "$(CONSUMER_CONSUMER_R2U2_BUILD_DIR)/temp.map" && \
		xxd -i -n r2u2_spec_bin "$(CONSUMER_CONSUMER_R2U2_SPEC_BIN)" "$(CONSUMER_CONSUMER_R2U2_SPEC_C)"

$(CONSUMER_CONSUMER_R2U2_OBJ_DIR)/spec_bin.o: $(CONSUMER_CONSUMER_R2U2_SPEC_BIN) Makefile
	mkdir -p "$(@D)"
	$(CC) $(CFLAGS) -c "$(CONSUMER_CONSUMER_R2U2_SPEC_C)" -o "$@"

$(CONSUMER_CONSUMER_R2U2_OBJ_DIR)/r2u2_monitor.o: $(TOP_DIR)/components/consumer_consumer/src/r2u2_monitor.c $(TOP_DIR)/components/consumer_consumer/include/r2u2_monitor.h $(CONSUMER_CONSUMER_R2U2_SPEC_BIN) $(R2U2_SRC_DIR)/r2u2.h $(R2U2_PLATFORM_HEADERS) Makefile
	mkdir -p "$(@D)"
	$(CC) $(CONSUMER_CONSUMER_R2U2_CPPFLAGS) $(CFLAGS) -Wno-\#warnings -c "$<" -o "$@" $(TOP_INCLUDE) -I$(TOP_DIR)/components/consumer_consumer/include

$(CONSUMER_CONSUMER_R2U2_OBJ_DIR)/%.o: $(R2U2_SRC_DIR)/%.c $(CONSUMER_CONSUMER_R2U2_SPEC_BIN) $(R2U2_PLATFORM_HEADERS) Makefile
	mkdir -p "$(@D)"
	$(CC) $(CONSUMER_CONSUMER_R2U2_CPPFLAGS) $(CFLAGS) -Wno-\#warnings -Wno-logical-op-parentheses -Wno-unused-variable -c "$<" -o "$@"

consumer_consumer.o: $(TOP_DIR)/components/consumer_consumer/include/r2u2_monitor.h
