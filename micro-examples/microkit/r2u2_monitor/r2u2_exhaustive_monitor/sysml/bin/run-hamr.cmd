...
val packageName: String = "r2u2_exhaustive_monitor"
...
var codegenArgs: ISZ[String] = ISZ(
  ...
  "--sel4-output-dir", (hamrDir / "microkit_mcs_sysml").value,
  "--verbose",
  "--no-proyek-ive",
  "--workspace-root-dir", sysmlDir.string,
  "--sourcepath", sourcePath,
  "--system-name", "Exhaustive_Monitor::Sys_i",
)

codegenArgs = codegenArgs ++ Os.cliArgs

codegenArgs = codegenArgs :+ (sysmlDir / "Exhaustive_Monitor.sysml").value
