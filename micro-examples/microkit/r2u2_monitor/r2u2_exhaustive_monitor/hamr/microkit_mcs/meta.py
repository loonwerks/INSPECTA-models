...
def generate(sdf_path: str, output_dir: str, dtb: DeviceTree):
    ...
    producer_producer.add_map(Map(Sys_i_Instance_producer_producer_boolean_value_1_Memory_Region, 0x10_002_000, perms="rw", setvar_vaddr="boolean_value_queue_1"))
    monitor_monitor.add_map(Map(Sys_i_Instance_producer_producer_boolean_value_1_Memory_Region, 0x10_002_000, perms="r", setvar_vaddr="boolean_value_queue_1"))
    producer_producer.add_map(Map(Sys_i_Instance_producer_producer_character_value_1_Memory_Region, 0x10_004_000, perms="rw", setvar_vaddr="character_value_queue_1"))
    monitor_monitor.add_map(Map(Sys_i_Instance_producer_producer_character_value_1_Memory_Region, 0x10_004_000, perms="r", setvar_vaddr="character_value_queue_1"))
    ...
    monitor_monitor.add_map(Map(Sys_i_Instance_producer_producer_signed_8_value_1_Memory_Region, 0x10_006_000, perms="r", setvar_vaddr="signed_8_value_queue_1"))
    producer_producer.add_map(Map(Sys_i_Instance_producer_producer_signed_16_value_1_Memory_Region, 0x10_008_000, perms="rw", setvar_vaddr="signed_16_value_queue_1"))
    monitor_monitor.add_map(Map(Sys_i_Instance_producer_producer_signed_16_value_1_Memory_Region, 0x10_008_000, perms="r", setvar_vaddr="signed_16_value_queue_1"))
    producer_producer.add_map(Map(Sys_i_Instance_producer_producer_unsigned_8_value_1_Memory_Region, 0x10_00A_000, perms="rw", setvar_vaddr="unsigned_8_value_queue_1"))
    monitor_monitor.add_map(Map(Sys_i_Instance_producer_producer_unsigned_8_value_1_Memory_Region, 0x10_00A_000, perms="r", setvar_vaddr="unsigned_8_value_queue_1"))
    producer_producer.add_map(Map(Sys_i_Instance_producer_producer_unsigned_16_value_1_Memory_Region, 0x10_00C_000, perms="rw", setvar_vaddr="unsigned_16_value_queue_1"))
    monitor_monitor.add_map(Map(Sys_i_Instance_producer_producer_unsigned_16_value_1_Memory_Region, 0x10_00C_000, perms="r", setvar_vaddr="unsigned_16_value_queue_1"))
    producer_producer.add_map(Map(Sys_i_Instance_producer_producer_sample_1_Memory_Region, 0x10_00E_000, perms="rw", setvar_vaddr="sample_queue_1"))
    monitor_monitor.add_map(Map(Sys_i_Instance_producer_producer_sample_1_Memory_Region, 0x10_00E_000, perms="r", setvar_vaddr="sample_queue_1"))
    producer_producer.add_map(Map(Sys_i_Instance_producer_producer_flag_1_Memory_Region, 0x10_010_000, perms="rw", setvar_vaddr="flag_queue_1"))
    monitor_monitor.add_map(Map(Sys_i_Instance_producer_producer_flag_1_Memory_Region, 0x10_010_000, perms="r", setvar_vaddr="flag_queue_1"))
    producer_producer.add_map(Map(Sys_i_Instance_producer_producer_operating_state_1_Memory_Region, 0x10_012_000, perms="rw", setvar_vaddr="operating_state_queue_1"))
    monitor_monitor.add_map(Map(Sys_i_Instance_producer_producer_operating_state_1_Memory_Region, 0x10_012_000, perms="r", setvar_vaddr="operating_state_queue_1"))
    producer_producer.add_map(Map(Sys_i_Instance_producer_producer_samples_1_Memory_Region, 0x10_014_000, perms="rw", setvar_vaddr="samples_queue_1"))
    monitor_monitor.add_map(Map(Sys_i_Instance_producer_producer_samples_1_Memory_Region, 0x10_014_000, perms="r", setvar_vaddr="samples_queue_1"))
    producer_producer.add_map(Map(Sys_i_Instance_producer_producer_telemetry_1_Memory_Region, 0x10_016_000, perms="rw", setvar_vaddr="telemetry_queue_1"))
    monitor_monitor.add_map(Map(Sys_i_Instance_producer_producer_telemetry_1_Memory_Region, 0x10_016_000, perms="r", setvar_vaddr="telemetry_queue_1"))
    producer_producer.add_map(Map(Sys_i_Instance_producer_producer_pulse_1_Memory_Region, 0x10_018_000, perms="rw", setvar_vaddr="pulse_queue_1"))
    monitor_monitor.add_map(Map(Sys_i_Instance_producer_producer_pulse_1_Memory_Region, 0x10_018_000, perms="r", setvar_vaddr="pulse_queue_1"))
    monitor_monitor.add_map(Map(Sys_i_Instance_monitor_monitor_healthy_1_Memory_Region, 0x10_01A_000, perms="rw", setvar_vaddr="healthy_queue_1"))
    ...
    monitor_monitor.add_map(Map(Sys_i_Instance_monitor_monitor_echo_1_Memory_Region, 0x10_01C_000, perms="rw", setvar_vaddr="echo_queue_1"))
    consumer_consumer.add_map(Map(Sys_i_Instance_monitor_monitor_echo_1_Memory_Region, 0x10_002_000, perms="r", setvar_vaddr="echo_queue_1"))
    monitor_monitor.add_map(Map(Sys_i_Instance_monitor_monitor_alert_result_1_Memory_Region, 0x10_01E_000, perms="rw", setvar_vaddr="alert_result_queue_1"))
    consumer_consumer.add_map(Map(Sys_i_Instance_monitor_monitor_alert_result_1_Memory_Region, 0x10_004_000, perms="r", setvar_vaddr="alert_result_queue_1"))
    monitor_monitor.add_map(Map(Sys_i_Instance_monitor_monitor_ack_1_Memory_Region, 0x10_020_000, perms="rw", setvar_vaddr="ack_queue_1"))
    consumer_consumer.add_map(Map(Sys_i_Instance_monitor_monitor_ack_1_Memory_Region, 0x10_006_000, perms="r", setvar_vaddr="ack_queue_1"))
