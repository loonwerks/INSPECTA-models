...
verus! {
  ...
  impl monitor_monitor {
      ...
      api: &monitor_monitor_Application_Api<API>)
    {
      ...
      r2u2_core::load_int_signal(&mut self.r2u2_monitor, 29, (telemetry.unwrap_or_default()).operating_state as i32); // Loading enum signal api_telemetry_operating_state into index 29
      r2u2_core::load_int_array(&mut self.r2u2_monitor, 30, &((telemetry.unwrap_or_default()).values).map(|value| value as i32)); // Loading array signal api_telemetry_values into indices 30..33
