...
monitor_monitor.elf: $(UTIL_OBJS) monitor_monitor_rust monitor_monitor.o $(TYPES_LIB)
	$(LD) $(LDFLAGS) -L ${CRATES_DIR}/monitor_monitor/target/aarch64-unknown-none/$(RUST_PROFILE_DIR) $(filter %.o, $^) $(TYPES_LIB) $(LIBS) -lmonitor_monitor -o $@
