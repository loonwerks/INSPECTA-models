...
monitor_monitor.elf: $(UTIL_OBJS) $(TYPE_OBJS) monitor_monitor_rust monitor_monitor.o
	$(LD) $(LDFLAGS) -L ${CRATES_DIR}/monitor_monitor/target/aarch64-unknown-none/$(RUST_PROFILE_DIR) $(filter %.o, $^) $(LIBS) -lmonitor_monitor -o $@
