...
verus! {
  ...
  impl monitor_process_monitor_thread {
      ...
      api: &monitor_process_monitor_thread_Application_Api<API>)
    {
      ...
      r2u2_core::load_int_signal(&mut self.r2u2_monitor, 2, (sample.unwrap_or_default()) as i32); // Loading signal api_sample into index 2
      r2u2_core::load_int_signal(&mut self.r2u2_monitor, 3, (level) as i32); // Loading signal api_level into index 3
      r2u2_core::load_bool_signal(&mut self.r2u2_monitor, 4, boolean_value); // Loading signal api_boolean_value into index 4
      r2u2_core::load_int_signal(&mut self.r2u2_monitor, 5, (character_value) as i32); // Loading signal api_character_value into index 5
      r2u2_core::load_int_signal(&mut self.r2u2_monitor, 6, (signed_8_value) as i32); // Loading signal api_signed_8_value into index 6
      r2u2_core::load_int_signal(&mut self.r2u2_monitor, 7, (signed_16_value) as i32); // Loading signal api_signed_16_value into index 7
      r2u2_core::load_int_signal(&mut self.r2u2_monitor, 8, (unsigned_8_value) as i32); // Loading signal api_unsigned_8_value into index 8
      r2u2_core::load_int_signal(&mut self.r2u2_monitor, 9, (unsigned_16_value) as i32); // Loading signal api_unsigned_16_value into index 9
      ...
      r2u2_core::load_bool_signal(&mut self.r2u2_monitor, 20, samples.is_some()); // Loading signal api_samples_nonEmpty into index 20
      r2u2_core::load_int_signal(&mut self.r2u2_monitor, 21, (samples.unwrap_or_default().len()) as i32); // Loading signal api_samples_size into index 21
      r2u2_core::load_int_array(&mut self.r2u2_monitor, 22, &(samples.unwrap_or_default()).map(|value| value as i32)); // Loading array signal api_samples into indices 22..25
      r2u2_core::load_bool_signal(&mut self.r2u2_monitor, 26, telemetry.is_some()); // Loading signal api_telemetry_nonEmpty into index 26
      r2u2_core::load_int_signal(&mut self.r2u2_monitor, 27, ((telemetry.unwrap_or_default()).sequence_number) as i32); // Loading signal api_telemetry_sequence_number into index 27
      r2u2_core::load_bool_signal(&mut self.r2u2_monitor, 28, (telemetry.unwrap_or_default()).valid); // Loading signal api_telemetry_valid into index 28
      r2u2_core::load_int_array(&mut self.r2u2_monitor, 29, &((telemetry.unwrap_or_default()).values).map(|value| value as i32)); // Loading array signal api_telemetry_values into indices 29..32
      r2u2_core::load_int_signal(&mut self.r2u2_monitor, 33, (telemetry.unwrap_or_default()).operating_state as i32); // Loading enum signal api_telemetry_operating_state into index 33
      r2u2_core::load_int_signal(&mut self.r2u2_monitor, 35, (self.sprevious_level) as i32); // Loading signal in_sprevious_level into index 35
      r2u2_core::load_bool_signal(&mut self.r2u2_monitor, 36, GUMBOX::isNonNegative(level)); // Loading signal fn_isNonNegative_level into index 36
      r2u2_core::load_int_signal(&mut self.r2u2_monitor, 37, (GUMBOX::absoluteValue(level)) as i32); // Loading signal fn_absoluteValue_level into index 37
    }
      ...
      api: &mut monitor_process_monitor_thread_Application_Api<API>)
    {
      ...
      r2u2_core::load_int_signal(&mut self.r2u2_monitor, 16, (echo.unwrap_or_default()) as i32); // Loading signal api_echo into index 16
      r2u2_core::load_bool_signal(&mut self.r2u2_monitor, 17, healthy); // Loading signal api_healthy into index 17
      r2u2_core::load_int_signal(&mut self.r2u2_monitor, 34, (self.sprevious_level) as i32); // Loading signal sprevious_level into index 34
      ...
      if let Some(verdict) = self.r2u2_monitor.verdict_cache[22] {
          if !verdict.truth {
              api.put_ack();
          }
      }
