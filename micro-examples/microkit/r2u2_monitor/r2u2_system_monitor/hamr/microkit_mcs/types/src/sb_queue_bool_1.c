...
bool sb_queue_bool_1_peek_latest(
  ...
  sb_queue_bool_1_Recv_t snapshot = {
    .numRecv = numSent - 1,
    .queue = queue
  };
  sb_event_counter_t numDropped;
  return sb_queue_bool_1_dequeue(&snapshot, &numDropped, data);
}
...
bool sb_queue_bool_1_peek(
  ...
  sb_queue_bool_1_Recv_t snapshot = *recvQueue;
  return sb_queue_bool_1_dequeue(&snapshot, numDropped, data);
}
