...
def generate(sdf_path: str, output_dir: str, dtb: DeviceTree):
    ...
    monitor_process_monitor_thread.add_map(Map(Sys_i_Instance_consumer_consumer_observed_sample_1_Memory_Region, 0x10_002_000, perms="r", setvar_vaddr="observed_sample_queue_1"))
    consumer_consumer.add_map(Map(Sys_i_Instance_monitor_process_monitor_thread_alert_flag_1_Memory_Region, 0x10_004_000, perms="r", setvar_vaddr="alert_flag_queue_1"))
    monitor_process_monitor_thread.add_map(Map(Sys_i_Instance_monitor_process_monitor_thread_alert_flag_1_Memory_Region, 0x10_004_000, perms="rw", setvar_vaddr="alert_flag_queue_1"))
