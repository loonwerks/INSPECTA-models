...
// SB_QUEUE_VEST_1PROD_1CONS_ARRAYOFBYTE_1_SIZE-1 elements.
#define SB_QUEUE_VEST_1PROD_1CONS_ARRAYOFBYTE_1_SIZE 2
...
typedef struct sb_queue_vest_1prod_1cons_ArrayOfByte_1 {
  ...
  // Queue of elements of type vest_1prod_1cons_ArrayOfByte
  // (see sb_types.h) implemented as a ring buffer.
  // No initialization necessary.
  vest_1prod_1cons_ArrayOfByte elt[SB_QUEUE_VEST_1PROD_1CONS_ARRAYOFBYTE_1_SIZE];

} sb_queue_vest_1prod_1cons_ArrayOfByte_1_t;
...
typedef struct sb_queue_vest_1prod_1cons_ArrayOfByte_1_Recv {
...
} sb_queue_vest_1prod_1cons_ArrayOfByte_1_Recv_t;
...
// dropped since the last call to sb_queue_vest_1prod_1cons_ArrayOfByte_1_dequeue(). *data is left in
// unspecified state.
//
// If the sender ever gets ahead of a receiver by more than COUNTER_MAX,
// sb_queue_vest_1prod_1cons_ArrayOfByte_1_dequeue will fail to count a multiple of COUNTER_MAX in
