...
volatile sb_queue_uint8_t_1_t *read_port1_queue_1 = (volatile sb_queue_uint8_t_1_t *) 0x10000000;
sb_queue_uint8_t_1_Recv_t read_port1_recv_queue;
volatile sb_queue_uint8_t_1_t *read_port2_queue_1 = (volatile sb_queue_uint8_t_1_t *) 0x10001000;
