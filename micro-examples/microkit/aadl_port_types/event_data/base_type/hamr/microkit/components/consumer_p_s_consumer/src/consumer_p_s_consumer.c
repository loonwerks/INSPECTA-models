...
volatile sb_queue_int8_t_1_t *read_port1_queue_1;
sb_queue_int8_t_1_Recv_t read_port1_recv_queue;
volatile sb_queue_int8_t_1_t *read_port2_queue_1;
sb_queue_int8_t_1_Recv_t read_port2_recv_queue;

#define PORT_FROM_MON 54

bool read_port1_is_empty(void) {
  return sb_queue_int8_t_1_is_empty(&read_port1_recv_queue);
}
...
bool get_read_port2_poll(sb_event_counter_t *numDropped, int8_t *data) {
  return sb_queue_int8_t_1_dequeue((sb_queue_int8_t_1_Recv_t *) &read_port2_recv_queue, numDropped, data);
}
...
void init(void) {
  sb_queue_int8_t_1_Recv_init(&read_port1_recv_queue, (sb_queue_int8_t_1_t *) read_port1_queue_1);

  sb_queue_int8_t_1_Recv_init(&read_port2_recv_queue, (sb_queue_int8_t_1_t *) read_port2_queue_1);
