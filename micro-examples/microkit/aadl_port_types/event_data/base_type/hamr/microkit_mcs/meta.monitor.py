...
def generate(sdf_path: str, output_dir: str, dtb: DeviceTree):
    ...
    monitor_process_monitor_thread.add_map(Map(top_impl_Instance_producer_p_p1_producer_write_port_1_Memory_Region, 0x10_000_000, perms="r"))
    ...
    channel_monitor_process_monitor_thread_MON = 6
