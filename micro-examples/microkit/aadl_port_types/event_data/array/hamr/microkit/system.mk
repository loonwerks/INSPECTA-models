...
TYPE_OBJS := printf.o util.o sb_queue_base_event_data_2_prod_2_cons_ArrayOfStruct_1.o sb_queue_base_event_data_2_prod_2_cons_ArrayOfStruct_1.o
...
sb_queue_base_event_data_2_prod_2_cons_ArrayOfStruct_1.o: ${TOP}/src/sb_queue_base_event_data_2_prod_2_cons_ArrayOfStruct_1.c Makefile
	$(CC) -c $(CFLAGS) $< -o $@ -I${TOP}/include
