...
#define SB_QUEUE_EVENT_DATA_2_PROD_2_CONS_ARRAY_ARRAYOFSTRUCT_1_REGION_BYTES 4096
_Static_assert(sizeof(sb_queue_event_data_2_prod_2_cons_array_ArrayOfStruct_1_t) <= SB_QUEUE_EVENT_DATA_2_PROD_2_CONS_ARRAY_ARRAYOFSTRUCT_1_REGION_BYTES,
  "sb_queue_event_data_2_prod_2_cons_array_ArrayOfStruct_1_t outgrows its shared memory region");
...
//
// An element holding an invalid bit pattern (see sb_queue_event_data_2_prod_2_cons_array_ArrayOfStruct_1_numInvalid) is never
...
static inline uintmax_t sb_queue_event_data_2_prod_2_cons_array_ArrayOfStruct_1_numInvalid(sb_queue_event_data_2_prod_2_cons_array_ArrayOfStruct_1_Recv_t *recvQueue) {
