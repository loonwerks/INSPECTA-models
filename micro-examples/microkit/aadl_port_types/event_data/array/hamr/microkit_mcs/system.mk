...
CFLAGS += \
	...
	-I$(TOP_DIR)/components/producer_p_p1_producer/include -I$(TOP_DIR)/components/producer_p_p2_producer/include -I$(TOP_DIR)/components/consumer_p_p_consumer/include -I$(TOP_DIR)/components/consumer_p_s_consumer/include


UTIL_OBJS :=

TYPE_OBJS := sb_queue_event_data_2_prod_2_cons_array_ArrayOfStruct_1.o sb_queue_event_data_2_prod_2_cons_array_ArrayOfStruct_1.o
...
vpath %.c $(SDDF) \
	...
	$(TOP_DIR)/types/src \
	$(TOP_DIR)/components/producer_p_p1_producer/src $(TOP_DIR)/components/producer_p_p2_producer/src $(TOP_DIR)/components/consumer_p_p_consumer/src $(TOP_DIR)/components/consumer_p_s_consumer/src


IMAGES := timer_driver.elf scheduler.elf \
	producer_p_p1_producer.elf producer_p_p1_producer_MON.elf producer_p_p2_producer.elf producer_p_p2_producer_MON.elf consumer_p_p_consumer.elf consumer_p_p_consumer_MON.elf consumer_p_s_consumer.elf consumer_p_s_consumer_MON.elf
