...
TYPE_OBJS := printf.o util.o sb_queue_base_data_1_prod_2_cons_ArrayOfStruct_1.o
...
sb_queue_base_data_1_prod_2_cons_ArrayOfStruct_1.o: ${TOP}/src/sb_queue_base_data_1_prod_2_cons_ArrayOfStruct_1.c Makefile
	$(CC) -c $(CFLAGS) $< -o $@ -I${TOP}/include
...
clean::
	rm -f producer_p_p_producer.o producer_p_p_producer_user.o producer_p_p_producer_MON.o consumer_p_p_consumer.o consumer_p_p_consumer_user.o consumer_p_p_consumer_MON.o consumer_p_s_consumer.o consumer_p_s_consumer_user.o consumer_p_s_consumer_MON.o pacer.o

clobber:: clean
	rm -f producer_p_p_producer.elf producer_p_p_producer_MON.elf consumer_p_p_consumer.elf consumer_p_p_consumer_MON.elf consumer_p_s_consumer.elf consumer_p_s_consumer_MON.elf pacer.elf ${IMAGE_FILE} ${REPORT_FILE}
