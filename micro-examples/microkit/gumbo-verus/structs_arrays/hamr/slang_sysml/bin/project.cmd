...
//     sireum proyek run . sysml.Demo
//
//   To see the available CLI options:
//     sireum proyek run . sysml.Demo -h
//
//   To run the example unit tests from the command line:
//     sireum proyek test .
//
//   To build an executable jar:
//     sireum proyek assemble --uber --main sysml.Demo .
//
// Sireum IVE:
//
...
//     Right click src/main/architecture/sysml/Demo.scala and choose "Run 'Demo'"
//
