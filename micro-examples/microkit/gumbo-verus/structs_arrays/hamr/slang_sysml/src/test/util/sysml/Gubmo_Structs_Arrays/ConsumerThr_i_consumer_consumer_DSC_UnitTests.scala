...
import sysml.util.UnitTestConfiguration

// Do not edit this file as it will be overwritten if HAMR codegen is rerun

object ConsumerThr_i_consumer_consumer_DSC_UnitTests extends App {
  def main(args: ISZ[String]): Z = {
    val instance = new ConsumerThr_i_consumer_consumer_DSC_UnitTests()
    /*
    val c = instance.next()
...
class ConsumerThr_i_consumer_consumer_DSC_UnitTests extends ConsumerThr_i_consumer_consumer_GumboX_UnitTests
  ...
  override def toCompactJson(o: Container): String = {
    return sysml.JSON.fromutilContainer(o, T)
  }

  override def fromJson(json: String): Container = {
    sysml.JSON.toutilContainer(json) match {
  ...
  override def test(o: Container): B = {
    ...
    val r: B = getConfig().test(o) match {
      case GumboXResult.Pre_Condition_Unsat =>
        sysml.DSC_RecordUnsatPre.report(toCompactJson(o))
        T
