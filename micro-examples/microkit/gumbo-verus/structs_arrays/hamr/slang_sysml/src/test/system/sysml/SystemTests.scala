...
class SystemTests extends SystemTestSuite {
  ...
  // import sysml.Gubmo_Structs_Arrays.{ProducerThr_i_producer_producer_SystemTestAPI => nickname}
  // import sysml.Gubmo_Structs_Arrays.{ConsumerThr_i_consumer_consumer_SystemTestAPI => nickname}
