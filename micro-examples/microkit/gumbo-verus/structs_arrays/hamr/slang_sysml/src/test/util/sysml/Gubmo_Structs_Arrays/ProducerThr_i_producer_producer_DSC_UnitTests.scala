...
object ProducerThr_i_producer_producer_DSC_UnitTests extends App {
  def main(args: ISZ[String]): Z = {
    val instance = new ProducerThr_i_producer_producer_DSC_UnitTests()
    /*
    val c = instance.next()
...
class ProducerThr_i_producer_producer_DSC_UnitTests extends ProducerThr_i_producer_producer_GumboX_UnitTests
