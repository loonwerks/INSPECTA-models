...
import sysml.util.{Container, UnitTestConfigurationBatch}
import sysml.Gubmo_Structs_Arrays.ConsumerThr_i_consumer_consumer_UnitTestConfiguration_Util._

// This file will not be overwritten so is safe to edit

class ConsumerThr_i_consumer_consumer_GumboX_UnitTests extends ConsumerThr_i_consumer_consumer_GumboX_TestHarness_ScalaTest {
