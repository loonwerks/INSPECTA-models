...
import sysml.SystemTestSuiteSlang._
import sysml.runtimemonitor.{GumboXDispatcher, ObservationKind, RuntimeMonitor, RuntimeMonitorListener}
...
@msig trait SystemTestSuiteSlang extends RuntimeMonitorListener {
  ...
  override def init(modelInfo: sysml.runtimemonitor.ModelInfo): Unit = {
  }
  ...
  override def observeComputePreState(bridgeId: art.Art.BridgeId, observationKind: sysml.runtimemonitor.ObservationKind.Type, pre: Option[art.DataContent]): Unit = {
