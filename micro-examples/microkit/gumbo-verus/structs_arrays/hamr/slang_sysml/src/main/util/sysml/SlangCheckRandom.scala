...
@msig trait RandomLibI {
  ...
  def nextGubmo_Structs_ArraysMyEnumType(): Gubmo_Structs_Arrays.MyEnum.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, sysml.Gubmo_Structs_Arrays.MyEnum.numOfElements-1)

    var v: Gubmo_Structs_Arrays.MyEnum.Type = sysml.Gubmo_Structs_Arrays.MyEnum.byOrdinal(ordinal).get
    if(get_Config_Gubmo_Structs_ArraysMyEnumType.attempts >= 0) {
     for(i <- 0 to get_Config_Gubmo_Structs_ArraysMyEnumType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, sysml.Gubmo_Structs_Arrays.MyEnum.numOfElements-1)
       v = sysml.Gubmo_Structs_Arrays.MyEnum.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_Gubmo_Structs_ArraysMyEnumType.filter(v)) {
  ...
  def nextruntimemonitorObservationKindType(): runtimemonitor.ObservationKind.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, sysml.runtimemonitor.ObservationKind.numOfElements-1)

    var v: runtimemonitor.ObservationKind.Type = sysml.runtimemonitor.ObservationKind.byOrdinal(ordinal).get
    if(get_Config_runtimemonitorObservationKindType.attempts >= 0) {
     for(i <- 0 to get_Config_runtimemonitorObservationKindType.attempts) {
       ...
       ordinal= gen.nextZBetween(0, sysml.runtimemonitor.ObservationKind.numOfElements-1)
       v = sysml.runtimemonitor.ObservationKind.byOrdinal(ordinal).get
     }
    } else {
     while(T){
       if(get_Config_runtimemonitorObservationKindType.filter(v)) {
...
@record class RandomLib(val gen: org.sireum.Random.Gen) extends RandomLibI {
  ...
  var config_Gubmo_Structs_ArraysMyArrayInt32: Config_Gubmo_Structs_ArraysMyArrayInt32 = Config_Gubmo_Structs_ArraysMyArrayInt32(100, _verbose, sysml.Gubmo_Structs_Arrays.MyArrayInt32.D_Inv_MyArrayInt32 _)
  ...
  var config_Gubmo_Structs_ArraysMyArrayStruct: Config_Gubmo_Structs_ArraysMyArrayStruct = Config_Gubmo_Structs_ArraysMyArrayStruct(100, _verbose, sysml.Gubmo_Structs_Arrays.MyArrayStruct.D_Inv_MyArrayStruct _)
