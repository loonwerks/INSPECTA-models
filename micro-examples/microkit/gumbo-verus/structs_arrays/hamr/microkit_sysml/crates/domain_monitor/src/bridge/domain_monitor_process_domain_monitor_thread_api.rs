...
verus! {
  ...
  impl<API: domain_monitor_process_domain_monitor_thread_Get_Api> domain_monitor_process_domain_monitor_thread_Application_Api<API> {
    pub fn get_producer_producer_p_myArrayInt32_DataPort(&mut self) -> (res : Gubmo_Structs_Arrays::MyArrayInt32)
      ensures
        old(self).producer_producer_p_myArrayInt32_DataPort == final(self).producer_producer_p_myArrayInt32_DataPort,
        res == final(self).producer_producer_p_myArrayInt32_DataPort,
        old(self).producer_producer_p_myArrayStruct_DataPort == final(self).producer_producer_p_myArrayStruct_DataPort,
        old(self).producer_producer_p_myStructArray_DataPort == final(self).producer_producer_p_myStructArray_DataPort,
        old(self).producer_producer_p_myArrayInt32_EventDataPort == final(self).producer_producer_p_myArrayInt32_EventDataPort,
        old(self).producer_producer_p_myArrayStruct_EventDataPort == final(self).producer_producer_p_myArrayStruct_EventDataPort,
    ...
    pub fn get_producer_producer_p_myArrayStruct_DataPort(&mut self) -> (res : Gubmo_Structs_Arrays::MyArrayStruct)
      ensures
        old(self).producer_producer_p_myArrayInt32_DataPort == final(self).producer_producer_p_myArrayInt32_DataPort,
        old(self).producer_producer_p_myArrayStruct_DataPort == final(self).producer_producer_p_myArrayStruct_DataPort,
        res == final(self).producer_producer_p_myArrayStruct_DataPort,
        old(self).producer_producer_p_myStructArray_DataPort == final(self).producer_producer_p_myStructArray_DataPort,
        old(self).producer_producer_p_myArrayInt32_EventDataPort == final(self).producer_producer_p_myArrayInt32_EventDataPort,
        old(self).producer_producer_p_myArrayStruct_EventDataPort == final(self).producer_producer_p_myArrayStruct_EventDataPort,
        old(self).producer_producer_p_myStructArray_EventDataPort == final(self).producer_producer_p_myStructArray_EventDataPort,
    ...
    pub fn get_producer_producer_p_myStructArray_DataPort(&mut self) -> (res : Gubmo_Structs_Arrays::MyStructArray_i)
      ensures
        ...
        old(self).producer_producer_p_myArrayStruct_DataPort == final(self).producer_producer_p_myArrayStruct_DataPort,
        old(self).producer_producer_p_myStructArray_DataPort == final(self).producer_producer_p_myStructArray_DataPort,
        res == final(self).producer_producer_p_myStructArray_DataPort,
        old(self).producer_producer_p_myArrayInt32_EventDataPort == final(self).producer_producer_p_myArrayInt32_EventDataPort,
        old(self).producer_producer_p_myArrayStruct_EventDataPort == final(self).producer_producer_p_myArrayStruct_EventDataPort,
        old(self).producer_producer_p_myStructArray_EventDataPort == final(self).producer_producer_p_myStructArray_EventDataPort,
    {
    ...
    pub fn get_producer_producer_p_myArrayInt32_EventDataPort(&mut self) -> (res : Option<Gubmo_Structs_Arrays::MyArrayInt32>)
      ensures
        ...
        old(self).producer_producer_p_myStructArray_DataPort == final(self).producer_producer_p_myStructArray_DataPort,
        old(self).producer_producer_p_myArrayInt32_EventDataPort == final(self).producer_producer_p_myArrayInt32_EventDataPort,
        res == final(self).producer_producer_p_myArrayInt32_EventDataPort,
        old(self).producer_producer_p_myArrayStruct_EventDataPort == final(self).producer_producer_p_myArrayStruct_EventDataPort,
        old(self).producer_producer_p_myStructArray_EventDataPort == final(self).producer_producer_p_myStructArray_EventDataPort,
    {
    ...
    pub fn get_producer_producer_p_myArrayStruct_EventDataPort(&mut self) -> (res : Option<Gubmo_Structs_Arrays::MyArrayStruct>)
      ensures
        ...
        old(self).producer_producer_p_myArrayInt32_EventDataPort == final(self).producer_producer_p_myArrayInt32_EventDataPort,
        old(self).producer_producer_p_myArrayStruct_EventDataPort == final(self).producer_producer_p_myArrayStruct_EventDataPort,
        res == final(self).producer_producer_p_myArrayStruct_EventDataPort,
        old(self).producer_producer_p_myStructArray_EventDataPort == final(self).producer_producer_p_myStructArray_EventDataPort,
    {
