  ...
  impl consumer_consumer {
    ...
    pub fn timeTriggered<API: consumer_consumer_Full_Api> (
      ...
      requires
        ...
        exists|i:int| 0 <= i <= old(api).myArrayInt32_DataPort.len() - 1 && #[trigger] old(api).myArrayInt32_DataPort[i] == 0,
      ...
      ensures
        ...
        exists|i:int| 0 <= i <= api.myArrayInt32_DataPort.len() - 1 && #[trigger] api.myArrayInt32_DataPort[i] == 0,
