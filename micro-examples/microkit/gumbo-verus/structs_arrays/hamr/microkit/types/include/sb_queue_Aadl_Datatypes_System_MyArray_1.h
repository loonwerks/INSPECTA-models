...
// SB_QUEUE_AADL_DATATYPES_SYSTEM_MYARRAY_1_SIZE-1 elements.
#define SB_QUEUE_AADL_DATATYPES_SYSTEM_MYARRAY_1_SIZE 2
...
typedef struct sb_queue_Aadl_Datatypes_System_MyArray_1 {
  ...
  // Queue of elements of type Aadl_Datatypes_System_MyArray
  // (see sb_types.h) implemented as a ring buffer.
  // No initialization necessary.
  Aadl_Datatypes_System_MyArray elt[SB_QUEUE_AADL_DATATYPES_SYSTEM_MYARRAY_1_SIZE];

} sb_queue_Aadl_Datatypes_System_MyArray_1_t;
...
typedef struct sb_queue_Aadl_Datatypes_System_MyArray_1_Recv {
...
} sb_queue_Aadl_Datatypes_System_MyArray_1_Recv_t;
...
// dropped since the last call to sb_queue_Aadl_Datatypes_System_MyArray_1_dequeue(). *data is left in
// unspecified state.
//
// If the sender ever gets ahead of a receiver by more than COUNTER_MAX,
// sb_queue_Aadl_Datatypes_System_MyArray_1_dequeue will fail to count a multiple of COUNTER_MAX in
