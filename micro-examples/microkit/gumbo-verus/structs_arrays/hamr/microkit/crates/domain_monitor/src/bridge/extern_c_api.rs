...
pub fn unsafe_get_consumer_consumer_MyArrayInt32() -> Option<Gumbo_Structs_Arrays::MyArrayInt32>
{
  unsafe {
    ...
    if (get_consumer_consumer_MyArrayInt32(value)) {
      return Some(*value);
    } else {
      return None;
    }
...
lazy_static::lazy_static! {
  ...
  pub static ref IN_consumer_consumer_MyArrayInt32: Mutex<Option<Gumbo_Structs_Arrays::MyArrayInt32>> = Mutex::new(None);
}
...
pub fn initialize_test_globals() {
  unsafe {
    ...
    *IN_consumer_consumer_MyArrayInt32.lock().unwrap_or_else(|e| e.into_inner()) = None;
  }
}
...
{
  unsafe {
    match *IN_consumer_consumer_MyArrayInt32.lock().unwrap_or_else(|e| e.into_inner()) {
      Some(v) => {
        *value = v;
        return true;
      },
