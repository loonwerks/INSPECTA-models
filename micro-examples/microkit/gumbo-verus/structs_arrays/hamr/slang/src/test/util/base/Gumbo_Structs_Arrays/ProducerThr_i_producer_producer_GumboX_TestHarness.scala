...
@msig trait ProducerThr_i_producer_producer_GumboX_TestHarness extends ProducerThr_i_producer_producer_TestApi {
  ...
  def testInitialiseCB(
    ...
    val api_MyArrayStruct: Option[Gumbo_Structs_Arrays.MyArrayStruct] = get_MyArrayStruct()
    val api_myStructArray: Option[Gumbo_Structs_Arrays.MyStructArray_i] = get_myStructArray()
    ...
    val postResult = base.Gumbo_Structs_Arrays.ProducerThr_i_producer_producer_GumboX.inititialize_IEP_Post(api_MyArrayStruct, api_myStructArray)
  ...
  def testComputeCBJ(json: String): GumboXResult.Type = {
    base.JSON.toGumbo_Structs_ArraysProducerThr_i_producer_producer_PreState_Container(json) match {
  ...
  def testComputeCB(
    ...
    // [CheckPost]: invoke the oracle function
    val postResult = base.Gumbo_Structs_Arrays.ProducerThr_i_producer_producer_GumboX.compute_CEP_Post(api_MyArrayStruct, api_myStructArray)
    val result: GumboXResult.Type =
      if (!postResult) GumboXResult.Post_Condition_Fail
      else GumboXResult.Post_Condition_Pass
