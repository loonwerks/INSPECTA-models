...
object Arch {
  val Sys_i_Instance_producer_producer : base.Gubmo_Structs_Arrays.ProducerThr_i_producer_producer_Bridge = {
    ...
    base.Gubmo_Structs_Arrays.ProducerThr_i_producer_producer_Bridge(
      id = bridgeId"0",
  ...
  val Sys_i_Instance_consumer_consumer : base.Gubmo_Structs_Arrays.ConsumerThr_i_consumer_consumer_Bridge = {
    ...
    base.Gubmo_Structs_Arrays.ConsumerThr_i_consumer_consumer_Bridge(
      id = bridgeId"1",
