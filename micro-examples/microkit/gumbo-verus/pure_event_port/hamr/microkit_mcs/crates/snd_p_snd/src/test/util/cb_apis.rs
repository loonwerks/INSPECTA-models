...
use crate::bridge::snd_p_snd_GUMBOX as GUMBOX;
...
pub fn testInitializeCB() -> HarnessResult
{
  ...
  let api_evt = get_evt();
  let api_out_val = get_out_val();

  // [CheckPost]: invoke the oracle function
  if !GUMBOX::initialize_IEP_Post (api_evt, api_out_val) {
...
pub fn testComputeCB() -> HarnessResult
{
  ...
  // [CheckPost]: invoke the oracle function
  if !GUMBOX::compute_CEP_Post(api_evt, api_out_val) {
