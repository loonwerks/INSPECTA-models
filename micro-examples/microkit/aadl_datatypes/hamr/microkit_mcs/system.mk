...
CFLAGS += \
	...
	-I$(TOP_DIR)/components/producer_producer/include -I$(TOP_DIR)/components/consumer_consumer/include


UTIL_OBJS :=

TYPE_OBJS := sb_queue_bool_1.o sb_queue_char_1.o sb_queue_Base_Types_String_1.o sb_queue_int8_t_1.o sb_queue_int16_t_1.o sb_queue_int32_t_1.o sb_queue_int64_t_1.o sb_queue_uint8_t_1.o sb_queue_uint16_t_1.o sb_queue_uint32_t_1.o sb_queue_uint64_t_1.o sb_queue_float_1.o sb_queue_double_1.o sb_queue_Aadl_Datatypes_MyEnum_1.o sb_queue_Aadl_Datatypes_MyStruct_i_1.o sb_queue_Aadl_Datatypes_MyArrayOneDim_1.o
...
vpath %.c $(SDDF) \
	...
	$(TOP_DIR)/types/src \
	$(TOP_DIR)/components/producer_producer/src $(TOP_DIR)/components/consumer_consumer/src


IMAGES := timer_driver.elf scheduler.elf \
	producer_producer.elf producer_producer_MON.elf consumer_consumer.elf consumer_consumer_MON.elf
