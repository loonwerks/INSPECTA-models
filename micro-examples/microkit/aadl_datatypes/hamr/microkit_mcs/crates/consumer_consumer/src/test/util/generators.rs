...
pub fn Aadl_Datatypes_MyStruct_i_strategy_cust
  <fieldInt64_i64_strategy: Strategy<Value = i64>, 
   ...
   myEnum_Aadl_Datatypes_MyEnum_strategy: Strategy<Value = Aadl_Datatypes::MyEnum>> (
  ...
  fieldArray_strategy: fieldArray_Aadl_Datatypes_MyArrayOneDim_strategy,
  myEnum_strategy: myEnum_Aadl_Datatypes_MyEnum_strategy) -> impl Strategy<Value = Aadl_Datatypes::MyStruct_i>
{
  (fieldInt64_strategy, fieldStr_strategy, fieldRec_strategy, fieldArray_strategy, myEnum_strategy).prop_map(|(fieldInt64, fieldStr, fieldRec, fieldArray, myEnum)| {
    Aadl_Datatypes::MyStruct_i { fieldInt64, fieldStr, fieldRec, fieldArray, myEnum }
  })
}
