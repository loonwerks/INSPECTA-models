...
#define SB_QUEUE_AADL_DATATYPES_MYSTRUCT_I_1_REGION_BYTES 4096
_Static_assert(sizeof(sb_queue_Aadl_Datatypes_MyStruct_i_1_t) <= SB_QUEUE_AADL_DATATYPES_MYSTRUCT_I_1_REGION_BYTES,
  "sb_queue_Aadl_Datatypes_MyStruct_i_1_t outgrows its shared memory region");
...
//
// An element holding an invalid bit pattern (see sb_queue_Aadl_Datatypes_MyStruct_i_1_numInvalid) is never
...
static inline uintmax_t sb_queue_Aadl_Datatypes_MyStruct_i_1_numInvalid(sb_queue_Aadl_Datatypes_MyStruct_i_1_Recv_t *recvQueue) {
