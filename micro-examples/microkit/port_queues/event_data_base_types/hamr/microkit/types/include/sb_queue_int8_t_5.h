...
#define SB_QUEUE_INT8_T_5_REGION_BYTES 4096
_Static_assert(sizeof(sb_queue_int8_t_5_t) <= SB_QUEUE_INT8_T_5_REGION_BYTES,
  "sb_queue_int8_t_5_t outgrows its shared memory region");
...
//
// An element holding an invalid bit pattern (see sb_queue_int8_t_5_numInvalid) is never
...
static inline uintmax_t sb_queue_int8_t_5_numInvalid(sb_queue_int8_t_5_Recv_t *recvQueue) {
