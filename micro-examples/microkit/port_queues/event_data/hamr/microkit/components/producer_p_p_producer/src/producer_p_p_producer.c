...
volatile sb_queue_int8_t_2_t *write_port_queue_2;
volatile sb_queue_int8_t_5_t *write_port_queue_5;
...
void init(void) {
  ...
  sb_queue_int8_t_2_init((sb_queue_int8_t_2_t *) write_port_queue_2);

  sb_queue_int8_t_5_init((sb_queue_int8_t_5_t *) write_port_queue_5);
