...
// SB_QUEUE_EVENT_DATA_ARRAY_PORT_QUEUES_ARRAYOFSTRUCT_5_SIZE-1 elements.
...
typedef struct sb_queue_event_data_array_port_queues_ArrayOfStruct_5 {
  ...
  // Queue of elements of type event_data_array_port_queues_ArrayOfStruct
  // (see sb_types.h) implemented as a ring buffer.
  // No initialization necessary.
  event_data_array_port_queues_ArrayOfStruct elt[SB_QUEUE_EVENT_DATA_ARRAY_PORT_QUEUES_ARRAYOFSTRUCT_5_SIZE];

} sb_queue_event_data_array_port_queues_ArrayOfStruct_5_t;
...
typedef struct sb_queue_event_data_array_port_queues_ArrayOfStruct_5_Recv {
...
} sb_queue_event_data_array_port_queues_ArrayOfStruct_5_Recv_t;
...
// dropped since the last call to sb_queue_event_data_array_port_queues_ArrayOfStruct_5_dequeue(). *data is left in
// unspecified state.
//
// If the sender ever gets ahead of a receiver by more than COUNTER_MAX,
// sb_queue_event_data_array_port_queues_ArrayOfStruct_5_dequeue will fail to count a multiple of COUNTER_MAX in
