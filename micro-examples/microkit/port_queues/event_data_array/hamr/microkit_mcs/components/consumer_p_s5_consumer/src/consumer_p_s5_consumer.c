...
volatile sb_queue_event_data_array_port_queues_ArrayOfStruct_5_t *read_port_queue_5 = (volatile sb_queue_event_data_array_port_queues_ArrayOfStruct_5_t *) 0x10000000;
sb_queue_event_data_array_port_queues_ArrayOfStruct_5_Recv_t read_port_recv_queue;

#define PORT_FROM_MON 0

bool read_port_is_empty(void) {
  return sb_queue_event_data_array_port_queues_ArrayOfStruct_5_is_empty(&read_port_recv_queue);
}

bool get_read_port_poll(sb_event_counter_t *numDropped, event_data_array_port_queues_ArrayOfStruct *data) {
  return sb_queue_event_data_array_port_queues_ArrayOfStruct_5_dequeue((sb_queue_event_data_array_port_queues_ArrayOfStruct_5_Recv_t *) &read_port_recv_queue, numDropped, data);
}
