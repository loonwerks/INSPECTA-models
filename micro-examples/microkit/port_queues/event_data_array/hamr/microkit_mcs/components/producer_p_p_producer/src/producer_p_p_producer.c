...
volatile sb_queue_event_data_array_port_queues_ArrayOfStruct_1_t *write_port_queue_1 = (volatile sb_queue_event_data_array_port_queues_ArrayOfStruct_1_t *) 0x10000000;
volatile sb_queue_event_data_array_port_queues_ArrayOfStruct_2_t *write_port_queue_2 = (volatile sb_queue_event_data_array_port_queues_ArrayOfStruct_2_t *) 0x10001000;
volatile sb_queue_event_data_array_port_queues_ArrayOfStruct_5_t *write_port_queue_5 = (volatile sb_queue_event_data_array_port_queues_ArrayOfStruct_5_t *) 0x10002000;
...
void init(void) {
  ...
  sb_queue_event_data_array_port_queues_ArrayOfStruct_1_init((sb_queue_event_data_array_port_queues_ArrayOfStruct_1_t *) write_port_queue_1);

  sb_queue_event_data_array_port_queues_ArrayOfStruct_2_init((sb_queue_event_data_array_port_queues_ArrayOfStruct_2_t *) write_port_queue_2);

  sb_queue_event_data_array_port_queues_ArrayOfStruct_5_init((sb_queue_event_data_array_port_queues_ArrayOfStruct_5_t *) write_port_queue_5);
