...
volatile sb_queue_event_data_array_port_queues_ArrayOfStruct_1_t *write_port_queue_1;
volatile sb_queue_event_data_array_port_queues_ArrayOfStruct_2_t *write_port_queue_2;
volatile sb_queue_event_data_array_port_queues_ArrayOfStruct_5_t *write_port_queue_5;
