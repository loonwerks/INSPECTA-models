...
// SB_QUEUE_EVENT_DATA_ARRAY_PORT_QUEUES_ARRAYOFSTRUCT_2_SIZE-1 elements.
...
typedef struct sb_queue_event_data_array_port_queues_ArrayOfStruct_2 {
  ...
  event_data_array_port_queues_ArrayOfStruct elt[SB_QUEUE_EVENT_DATA_ARRAY_PORT_QUEUES_ARRAYOFSTRUCT_2_SIZE];

} sb_queue_event_data_array_port_queues_ArrayOfStruct_2_t;
...
typedef struct sb_queue_event_data_array_port_queues_ArrayOfStruct_2_Recv {
...
} sb_queue_event_data_array_port_queues_ArrayOfStruct_2_Recv_t;
...
// dropped since the last call to sb_queue_event_data_array_port_queues_ArrayOfStruct_2_dequeue(). *data is left in
// unspecified state.
//
// If the sender ever gets ahead of a receiver by more than COUNTER_MAX,
// sb_queue_event_data_array_port_queues_ArrayOfStruct_2_dequeue will fail to count a multiple of COUNTER_MAX in
