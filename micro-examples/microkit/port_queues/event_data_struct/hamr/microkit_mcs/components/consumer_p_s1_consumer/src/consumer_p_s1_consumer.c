...
volatile sb_queue_event_data_struct_port_queues_struct_i_1_t *read_port_queue_1 = (volatile sb_queue_event_data_struct_port_queues_struct_i_1_t *) 0x10000000;
