...
// SB_QUEUE_EVENT_DATA_STRUCT_PORT_QUEUES_STRUCT_I_2_SIZE-1 elements.
...
typedef struct sb_queue_event_data_struct_port_queues_struct_i_2 {
  ...
  // Queue of elements of type event_data_struct_port_queues_struct_i
  // (see sb_types.h) implemented as a ring buffer.
  // No initialization necessary.
  event_data_struct_port_queues_struct_i elt[SB_QUEUE_EVENT_DATA_STRUCT_PORT_QUEUES_STRUCT_I_2_SIZE];

} sb_queue_event_data_struct_port_queues_struct_i_2_t;
...
typedef struct sb_queue_event_data_struct_port_queues_struct_i_2_Recv {
...
} sb_queue_event_data_struct_port_queues_struct_i_2_Recv_t;
...
// dropped since the last call to sb_queue_event_data_struct_port_queues_struct_i_2_dequeue(). *data is left in
// unspecified state.
//
// If the sender ever gets ahead of a receiver by more than COUNTER_MAX,
// sb_queue_event_data_struct_port_queues_struct_i_2_dequeue will fail to count a multiple of COUNTER_MAX in
