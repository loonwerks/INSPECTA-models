...
// SB_QUEUE_EVENT_DATA_STRUCT_PORT_QUEUES_STRUCT_I_1_SIZE-1 elements.
...
typedef struct sb_queue_event_data_struct_port_queues_struct_i_1_Recv {
...
} sb_queue_event_data_struct_port_queues_struct_i_1_Recv_t;
...
// dropped since the last call to sb_queue_event_data_struct_port_queues_struct_i_1_dequeue(). *data is left in
// unspecified state.
//
// If the sender ever gets ahead of a receiver by more than COUNTER_MAX,
// sb_queue_event_data_struct_port_queues_struct_i_1_dequeue will fail to count a multiple of COUNTER_MAX in
