...
use crate::bridge::A_sub_a_api::{self as api, *};
use crate::component::A_sub_a_app::*;
use data::*;

static mut app: Option<A_sub_a> = None;
static mut init_api: A_sub_a_Application_Api<A_sub_a_Initialization_Api> = api::init_api();
static mut compute_api: A_sub_a_Application_Api<A_sub_a_Compute_Api> = api::compute_api();

#[no_mangle]
pub extern "C" fn A_sub_a_initialize() {
...
#[no_mangle]
pub extern "C" fn A_sub_a_timeTriggered() {
  unsafe {
...
#[no_mangle]
pub extern "C" fn A_sub_a_notify(channel: microkit_channel) {
  unsafe {
    if let Some(_app) = app.as_mut() {
      _app.notify(channel);
    } else {
