...
mod tests {
  ...
  fn test_initialization() {
    crate::top_sub_A_sub_a_initialize();
  }
  ...
  fn test_compute() {
    ...
    test_apis::put_Input(0);

    crate::top_sub_A_sub_a_timeTriggered();
  }
}
...
mod GUMBOX_tests {
  ...
  testComputeCB_macro! {
    ...
    // range derived from GUMBO assume clause(s) constraining Input
    api_Input: (i32::MIN..=19i32)
  }
}
