...
use crate::bridge::top_sub_A_sub_a_GUMBOX as GUMBOX;
...
pub fn testInitializeCB() -> HarnessResult
{
  ...
  let api_Input = get_Input();
  let api_Output = get_Output();

  // [CheckPost]: invoke the oracle function
  if !GUMBOX::initialize_IEP_Post (api_Input, api_Output) {
...
/** Contract-based test harness for the compute entry point
  ...
  */
pub fn testComputeCB(api_Input: i32) -> HarnessResult
{
  // Initialize the app
  crate::top_sub_A_sub_a_initialize();
